...
{
    FSoftObjectPath LevelVariantSets;                                                 // 0x0298 (size: 0x20)
    TMap<UClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;        // 0x02B8 (size: 0x50)
...
class ASwitchActor : public AActor
{
    ...
    int32 LastSelectedOption;                                                         // 0x02B8 (size: 0x4)
