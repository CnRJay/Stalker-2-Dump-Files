...
{
    uint8 bOverrideSpawnCountScale;                                                   // 0x0050 (size: 0x1)
...
struct FNiagaraEmitterScalabilitySettings
{
    ...
    uint8 bScaleSpawnCountByDistanceCurve;                                            // 0x0038 (size: 0x1)
    FNiagaraLinearRamp SpawnCountScaleCurve;                                          // 0x003C (size: 0x10)
...
{
    EFTickBehaviour TickBehaviour;                                                    // 0x0000 (size: 0x4)
    float ScreenSize;                                                                 // 0x0004 (size: 0x4)
    int32 TicksCountToSkip;                                                           // 0x0008 (size: 0x4)
    float TickDeltaScale;                                                             // 0x000C (size: 0x4)
    bool bUseMotionVectors;                                                           // 0x0010 (size: 0x1)

}; // Size: 0x14

struct FNiagaraSystemTickLODArray
{
    TArray<FNiagaraSystemTickLOD> LODs;                                               // 0x0000 (size: 0x10)
...
struct FVersionedNiagaraEmitterData
{
    ...
    FNiagaraEmitterScalabilitySettings CurrentScalabilitySettings;                    // 0x0248 (size: 0x50)
...
class ANiagaraActor : public AActor
{
    ...
    FString GetAssetPathNameOrSetChangedHandler();
}; // Size: 0x2A8
...
class UNiagaraComponent : public UFXSystemComponent
{
    ...
    uint8 bAutoDestroy;                                                               // 0x0690 (size: 0x1)
    uint8 bRenderingEnabled;                                                          // 0x0690 (size: 0x1)
    FNiagaraSystemTickLODArray TickLODsInsideViewFrustum;                             // 0x0698 (size: 0x10)
    FNiagaraSystemTickLODArray TickLODsOutsideViewFrustum;                            // 0x06A8 (size: 0x10)
    uint8 bAutoManageAttachment;                                                      // 0x06B8 (size: 0x1)
    uint8 bAutoAttachWeldSimulatedBodies;                                             // 0x06B8 (size: 0x1)
    float MaxTimeBeforeForceUpdateTransform;                                          // 0x06BC (size: 0x4)
    FNiagaraComponentOnSystemFinished OnSystemFinished;                               // 0x06C8 (size: 0x10)
    void OnNiagaraSystemFinished(class UNiagaraComponent* PSystem);
    TWeakObjectPtr<class USceneComponent> AutoAttachParent;                           // 0x06D8 (size: 0x8)
    FName AutoAttachSocketName;                                                       // 0x06E0 (size: 0x8)
    EAttachmentRule AutoAttachLocationRule;                                           // 0x06E8 (size: 0x1)
    EAttachmentRule AutoAttachRotationRule;                                           // 0x06E9 (size: 0x1)
    EAttachmentRule AutoAttachScaleRule;                                              // 0x06EA (size: 0x1)
    uint8 bAllowScalability;                                                          // 0x06F4 (size: 0x1)
    class UNiagaraSimCache* SimCache;                                                 // 0x0820 (size: 0x8)
    class UNiagaraCullProxyComponent* CullProxy;                                      // 0x0828 (size: 0x8)
...
{
    TArray<FNiagaraCulledComponentInfo> Instances;                                    // 0x0830 (size: 0x10)
...
class UNiagaraEffectType : public UObject
{
    ...
    FNiagaraSystemTickLODArray TickLODsInsideViewFrustum;                             // 0x0090 (size: 0x10)
    FNiagaraSystemTickLODArray TickLODsOutsideViewFrustum;                            // 0x00A0 (size: 0x10)
    FNiagaraPerfBaselineStats PerfBaselineStats;                                      // 0x00B0 (size: 0x10)
    FGuid PerfBaselineVersion;                                                        // 0x00C0 (size: 0x10)
...
class UNiagaraSystem : public UFXSystemAsset
{
    ...
    bool bDumpDebugSystemInfo;                                                        // 0x0060 (size: 0x1)
    bool bDumpDebugEmitterInfo;                                                       // 0x0061 (size: 0x1)
    bool bRequireCurrentFrameData;                                                    // 0x0063 (size: 0x1)
    FNiagaraSystemTickLODArray TickLODsInsideViewFrustum;                             // 0x0068 (size: 0x10)
    FNiagaraSystemTickLODArray TickLODsOutsideViewFrustum;                            // 0x0078 (size: 0x10)
    uint8 bFixedBounds;                                                               // 0x0088 (size: 0x1)
    class UNiagaraEffectType* EffectType;                                             // 0x0090 (size: 0x8)
    bool bOverrideScalabilitySettings;                                                // 0x0098 (size: 0x1)
    uint8 bOverrideAllowCullingForLocalPlayers;                                       // 0x009C (size: 0x1)
    uint8 bAllowCullingForLocalPlayersOverride;                                       // 0x009C (size: 0x1)
    TArray<FNiagaraSystemScalabilityOverride> ScalabilityOverrides;                   // 0x00A0 (size: 0x10)
    FNiagaraSystemScalabilityOverrides SystemScalabilityOverrides;                    // 0x00B0 (size: 0x10)
    TArray<FNiagaraEmitterHandle> EmitterHandles;                                     // 0x00C0 (size: 0x10)
    TArray<class UNiagaraParameterCollectionInstance*> ParameterCollectionOverrides;  // 0x00D0 (size: 0x10)
    class UNiagaraScript* SystemSpawnScript;                                          // 0x00E0 (size: 0x8)
    class UNiagaraScript* SystemUpdateScript;                                         // 0x00E8 (size: 0x8)
    FNiagaraSystemCompiledData SystemCompiledData;                                    // 0x0100 (size: 0x228)
    FNiagaraUserRedirectionParameterStore ExposedParameters;                          // 0x0328 (size: 0xD8)
    FBox FixedBounds;                                                                 // 0x0400 (size: 0x38)
    bool bAutoDeactivate;                                                             // 0x0438 (size: 0x1)
    bool bDeterminism;                                                                // 0x0439 (size: 0x1)
    int32 RandomSeed;                                                                 // 0x043C (size: 0x4)
    float WarmupTime;                                                                 // 0x0440 (size: 0x4)
    int32 WarmupTickCount;                                                            // 0x0444 (size: 0x4)
    float WarmupTickDelta;                                                            // 0x0448 (size: 0x4)
    bool bFixedTickDelta;                                                             // 0x044C (size: 0x1)
    float FixedTickDeltaTime;                                                         // 0x0450 (size: 0x4)
    bool bHasSystemScriptDIsWithPerInstanceData;                                      // 0x0454 (size: 0x1)
    bool bNeedsGPUContextInitForDataInterfaces;                                       // 0x0455 (size: 0x1)
    TArray<FName> UserDINamesReadInSystemScripts;                                     // 0x0458 (size: 0x10)
