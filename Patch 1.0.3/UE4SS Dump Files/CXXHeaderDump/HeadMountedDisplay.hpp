...
{
    int32 PlayerIndex;                                                                // 0x0560 (size: 0x4)
    EControllerHand Hand;                                                             // 0x0564 (size: 0x1)
    FName MotionSource;                                                               // 0x0568 (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x0570 (size: 0x1)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x0574 (size: 0x1)
    bool bDisplayDeviceModel;                                                         // 0x0575 (size: 0x1)
    FName DisplayModelSource;                                                         // 0x0578 (size: 0x8)
    class UStaticMesh* CustomDisplayMesh;                                             // 0x0580 (size: 0x8)
    TArray<class UMaterialInterface*> DisplayMeshMaterialOverrides;                   // 0x0588 (size: 0x10)
    class UPrimitiveComponent* DisplayComponent;                                      // 0x0668 (size: 0x8)
