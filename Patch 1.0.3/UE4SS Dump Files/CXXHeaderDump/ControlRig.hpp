...
class AControlRigControlActor : public AActor
{
    ...
    TSoftObjectPtr<UControlRig> ControlRig;                                           // 0x02D8 (size: 0x30)
    TArray<FName> ControlNames;                                                       // 0x0308 (size: 0x10)
    TArray<FTransform> ShapeTransforms;                                               // 0x0318 (size: 0x10)
    TArray<class UStaticMeshComponent*> Components;                                   // 0x0328 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> Materials;                                // 0x0338 (size: 0x10)
    FName ColorParameterName;                                                         // 0x0348 (size: 0x8)
...
{
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0560 (size: 0x8)
    FControlRigComponentOnPreInitializeDelegate OnPreInitializeDelegate;              // 0x0568 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostInitializeDelegate OnPostInitializeDelegate;            // 0x0578 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreConstructionDelegate OnPreConstructionDelegate;          // 0x0588 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostConstructionDelegate OnPostConstructionDelegate;        // 0x0598 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreForwardsSolveDelegate OnPreForwardsSolveDelegate;        // 0x05A8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostForwardsSolveDelegate OnPostForwardsSolveDelegate;      // 0x05B8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    TArray<FControlRigComponentMappedElement> UserDefinedElements;                    // 0x05C8 (size: 0x10)
    TArray<FControlRigComponentMappedElement> MappedElements;                         // 0x05D8 (size: 0x10)
    bool bEnableLazyEvaluation;                                                       // 0x05E8 (size: 0x1)
    float LazyEvaluationPositionThreshold;                                            // 0x05EC (size: 0x4)
    float LazyEvaluationRotationThreshold;                                            // 0x05F0 (size: 0x4)
    float LazyEvaluationScaleThreshold;                                               // 0x05F4 (size: 0x4)
    bool bResetTransformBeforeTick;                                                   // 0x05F8 (size: 0x1)
    bool bResetInitialsBeforeConstruction;                                            // 0x05F9 (size: 0x1)
    bool bUpdateRigOnTick;                                                            // 0x05FA (size: 0x1)
    bool bUpdateInEditor;                                                             // 0x05FB (size: 0x1)
    bool bDrawBones;                                                                  // 0x05FC (size: 0x1)
    bool bShowDebugDrawing;                                                           // 0x05FD (size: 0x1)
    class UControlRig* ControlRig;                                                    // 0x0600 (size: 0x8)
