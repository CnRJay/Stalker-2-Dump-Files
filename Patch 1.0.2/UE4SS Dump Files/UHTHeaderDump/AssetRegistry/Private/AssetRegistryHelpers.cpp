...
void UAssetRegistryHelpers::SortAssetData(const TArray<FAssetData>& InAssetData, TArray<FAssetData>& OutAssetData) {
}
...
FString UAssetRegistryHelpers::GetShortName(const FAssetData& InAssetData) {
    return TEXT("");
}
