...
//CROSS-MODULE INCLUDE V2: -ModuleName=AkAudio -ObjectName=AkSpatialAudioVolume -FallbackName=AkSpatialAudioVolume
//CROSS-MODULE INCLUDE V2: -ModuleName=AkAudio -ObjectName=EAkCurveInterpolation -FallbackName=EAkCurveInterpolation
