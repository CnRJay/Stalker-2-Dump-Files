...
//CROSS-MODULE INCLUDE V2: -ModuleName=PoseSearch -ObjectName=AnimNotifyState_PoseSearchBlockTransition -FallbackName=AnimNotifyState_PoseSearchBlockTransition
