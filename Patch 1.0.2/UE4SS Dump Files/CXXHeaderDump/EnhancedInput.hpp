...
struct FEnhancedActionKeyMapping
{
    ...
    uint8 bShouldBeAlwaysIgnored;                                                     // 0x0080 (size: 0x1)
...
struct FModifyContextOptions
{
    ...
    uint8 bForceRebuildWithFlush;                                                     // 0x0000 (size: 0x1)
...
class ITriggerProgress : public IInterface
{
}; // Size: 0x28
...
class UInputMappingContext : public UDataAsset
{
    ...
    void SetIgnoreAlwaysForAction(const class UInputAction* Action, const bool bIgnore);
...
{
    float HoldTimeThreshold;                                                          // 0x0064 (size: 0x4)
    bool bIsOneShot;                                                                  // 0x0068 (size: 0x1)

}; // Size: 0x70

class UInputTriggerHoldAndRelease : public UInputTriggerTimedBase
{
    float HoldTimeThreshold;                                                          // 0x0060 (size: 0x4)

}; // Size: 0x68

class UInputTriggerHoldWithActivationDelay : public UInputTriggerTimedBase
{
    float HoldTimeThreshold;                                                          // 0x0060 (size: 0x4)
    float HoldActivationThreshold;                                                    // 0x0064 (size: 0x4)
