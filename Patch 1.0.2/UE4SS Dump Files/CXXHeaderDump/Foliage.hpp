...
{
    class AProceduralFoliageVolume* ProceduralFoliageVolume;                          // 0x02D8 (size: 0x8)
    FFoliageDensityFalloff DensityFalloff;                                            // 0x02E0 (size: 0x90)

}; // Size: 0x370

class AProceduralFoliageVolume : public AVolume
{
    class UProceduralFoliageComponent* ProceduralComponent;                           // 0x02E0 (size: 0x8)

}; // Size: 0x2E8

class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{
    FFoliageInstancedStaticMeshComponentOnInstanceTakePointDamage OnInstanceTakePointDamage; // 0x0930 (size: 0x10)
    ...
    FFoliageInstancedStaticMeshComponentOnInstanceTakeRadialDamage OnInstanceTakeRadialDamage; // 0x0940 (size: 0x10)
    ...
    bool bEnableDiscardOnLoad;                                                        // 0x0950 (size: 0x1)
    FGuid GenerationGuid;                                                             // 0x0954 (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    uint8 bReceivesAttachedDecals;                                                    // 0x018C (size: 0x1)
