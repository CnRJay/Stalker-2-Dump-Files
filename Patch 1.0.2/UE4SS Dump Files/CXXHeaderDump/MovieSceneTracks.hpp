...
class IGSCSkeletalAnimationSectionSelectable : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneSectionTemplateDecorator : public IInterface
{
}; // Size: 0x28
...
{
    FString CharacterNameSID;                                                         // 0x00F0 (size: 0x10)
    FString TextSID;                                                                  // 0x0100 (size: 0x10)
    class USoundBase* Sound;                                                          // 0x0110 (size: 0x8)
    FFrameNumber StartFrameOffset;                                                    // 0x0118 (size: 0x4)
    float StartOffset;                                                                // 0x011C (size: 0x4)
    float AudioStartTime;                                                             // 0x0120 (size: 0x4)
    float AudioDilationFactor;                                                        // 0x0124 (size: 0x4)
    float AudioVolume;                                                                // 0x0128 (size: 0x4)
    FMovieSceneFloatChannel SoundVolume;                                              // 0x0130 (size: 0x110)
    FMovieSceneFloatChannel PitchMultiplier;                                          // 0x0240 (size: 0x110)
    TMap<class FName, class FMovieSceneFloatChannel> Inputs_Float;                    // 0x0350 (size: 0x50)
    TMap<class FName, class FMovieSceneStringChannel> Inputs_String;                  // 0x03A0 (size: 0x50)
    TMap<class FName, class FMovieSceneBoolChannel> Inputs_Bool;                      // 0x03F0 (size: 0x50)
    TMap<class FName, class FMovieSceneIntegerChannel> Inputs_Int;                    // 0x0440 (size: 0x50)
    TMap<class FName, class FMovieSceneAudioTriggerChannel> Inputs_Trigger;           // 0x0490 (size: 0x50)
    FMovieSceneActorReferenceData AttachActorData;                                    // 0x04E0 (size: 0x120)
    bool bLooping;                                                                    // 0x0600 (size: 0x1)
    bool bSuppressSubtitles;                                                          // 0x0601 (size: 0x1)
    bool bOverrideAttenuation;                                                        // 0x0602 (size: 0x1)
    class USoundAttenuation* AttenuationSettings;                                     // 0x0608 (size: 0x8)
    FMovieSceneAudioSectionOnQueueSubtitles OnQueueSubtitles;                         // 0x0610 (size: 0x10)
    void OnQueueSubtitles(const TArray<FSubtitleCue>& Subtitles, float CueDuration);
    FMovieSceneAudioSectionOnAudioFinished OnAudioFinished;                           // 0x0620 (size: 0x10)
    void OnAudioFinished();
    FMovieSceneAudioSectionOnAudioPlaybackPercent OnAudioPlaybackPercent;             // 0x0630 (size: 0x10)
...
class UMovieSceneSkeletalAnimationSection : public UMovieSceneSection
{
    ...
    TSoftObjectPtr<AActor> SyncActor;                                                 // 0x0348 (size: 0x30)
    FVector SyncLocation;                                                             // 0x0378 (size: 0x18)
    FRotator SyncRotation;                                                            // 0x0390 (size: 0x18)
    TSoftObjectPtr<AActor> DynamicSyncActor;                                          // 0x03A8 (size: 0x30)
    FGuid DynamicSyncGuid;                                                            // 0x03D8 (size: 0x10)
    FRotator OverrideRotation;                                                        // 0x03E8 (size: 0x18)
    int32 BlendFramesNum;                                                             // 0x0400 (size: 0x4)
    float BlendExpForEaseInOut;                                                       // 0x0404 (size: 0x4)
    bool bUsedForPreblend;                                                            // 0x0408 (size: 0x1)
...
class UMovieSceneSkeletalAnimationTrack : public UMovieSceneNameableTrack
{
    ...
    bool bGSCIgnoreRootMotion;                                                        // 0x00E9 (size: 0x1)
