...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x05A0 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x05A1 (size: 0x1)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x05A8 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x05B0 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x05C0 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x05D0 (size: 0x38)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x0608 (size: 0x10)
