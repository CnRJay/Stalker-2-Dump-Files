...
struct FRecastNavMeshGenerationProperties
{
    ...
    uint8 bGenerateDetailedMesh;                                                      // 0x003C (size: 0x1)
    ...
    uint8 bIsWorldPartitioned;                                                        // 0x003D (size: 0x1)
...
{
    FNavAgentSelector SupportedAgents;                                                // 0x02D8 (size: 0x4)

}; // Size: 0x2E0

class ANavModifierVolume : public AVolume
{
    TSubclassOf<class UNavArea> AreaClass;                                            // 0x02E0 (size: 0x8)
    bool bMaskFillCollisionUnderneathForNavmesh;                                      // 0x02E8 (size: 0x1)
...
class ANavigationData : public AActor
{
    ...
    FNavDataConfig NavDataConfig;                                                     // 0x02A8 (size: 0x98)
    ...
    TArray<FSupportedAreaData> SupportedAreas;                                        // 0x0458 (size: 0x10)
...
class ANavigationTestingActor : public AActor
{
    ...
    uint8 bShouldBeVisibleInGame;                                                     // 0x033C (size: 0x1)
    ...
    float PathCost;                                                                   // 0x0360 (size: 0x4)
    int32 PathfindingSteps;                                                           // 0x0364 (size: 0x4)
...
{
    uint8 bDrawNavBoundsIntersection;                                                 // 0x04D8 (size: 0x1)
    uint8 bDrawNavBounds;                                                             // 0x04D8 (size: 0x1)
    uint8 bDrawDirtyTilesBB;                                                          // 0x04D8 (size: 0x1)
    uint8 bDrawTriangleEdges;                                                         // 0x04D8 (size: 0x1)
    uint8 bDrawPolyEdges;                                                             // 0x04D8 (size: 0x1)
    uint8 bDrawFilledPolys;                                                           // 0x04D8 (size: 0x1)
    uint8 bDrawNavMeshEdges;                                                          // 0x04D8 (size: 0x1)
    uint8 bDrawTileBounds;                                                            // 0x04D8 (size: 0x1)
    uint8 bDrawPathCollidingGeometry;                                                 // 0x04D9 (size: 0x1)
    uint8 bDrawTileLabels;                                                            // 0x04D9 (size: 0x1)
    uint8 bDrawPolygonLabels;                                                         // 0x04D9 (size: 0x1)
    uint8 bDrawDefaultPolygonCost;                                                    // 0x04D9 (size: 0x1)
    uint8 bDrawPolygonFlags;                                                          // 0x04D9 (size: 0x1)
    uint8 bDrawLabelsOnPathNodes;                                                     // 0x04D9 (size: 0x1)
    uint8 bDrawNavLinks;                                                              // 0x04D9 (size: 0x1)
    uint8 bDrawFailedNavLinks;                                                        // 0x04D9 (size: 0x1)
    uint8 bDrawClusters;                                                              // 0x04DA (size: 0x1)
    uint8 bDrawOctree;                                                                // 0x04DA (size: 0x1)
    uint8 bDrawOctreeDetails;                                                         // 0x04DA (size: 0x1)
    uint8 bDrawMarkedForbiddenPolys;                                                  // 0x04DA (size: 0x1)
    uint8 bDistinctlyDrawTilesBeingBuilt;                                             // 0x04DA (size: 0x1)
    float DrawOffset;                                                                 // 0x04DC (size: 0x4)
    FRecastNavMeshTileGenerationDebug TileGenerationDebug;                            // 0x04E0 (size: 0x14)
    uint8 bFixedTilePoolSize;                                                         // 0x04F4 (size: 0x1)
    int32 TilePoolSize;                                                               // 0x04F8 (size: 0x4)
    float TileSizeUU;                                                                 // 0x04FC (size: 0x4)
    float CellSize;                                                                   // 0x0500 (size: 0x4)
    float CellHeight;                                                                 // 0x0504 (size: 0x4)
    float AgentRadius;                                                                // 0x0508 (size: 0x4)
    float AgentHeight;                                                                // 0x050C (size: 0x4)
    float AgentMaxSlope;                                                              // 0x0510 (size: 0x4)
    float AgentMaxStepHeight;                                                         // 0x0514 (size: 0x4)
    float MinRegionArea;                                                              // 0x0518 (size: 0x4)
    float MergeRegionSize;                                                            // 0x051C (size: 0x4)
    float MaxSimplificationError;                                                     // 0x0520 (size: 0x4)
    int32 MaxSimultaneousTileGenerationJobsCount;                                     // 0x0524 (size: 0x4)
    int32 MaxAsyncBuildTasksEditor;                                                   // 0x0528 (size: 0x4)
    int32 MaxAsyncBuildTasksGameThread;                                               // 0x052C (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x0530 (size: 0x4)
    int32 PolyRefTileBits;                                                            // 0x0534 (size: 0x4)
    int32 PolyRefNavPolyBits;                                                         // 0x0538 (size: 0x4)
    int32 PolyRefSaltBits;                                                            // 0x053C (size: 0x4)
    ...
    uint8 bGenerateDetailedMesh;                                                      // 0x0570 (size: 0x1)
    ...
    uint8 bDoFullyAsyncNavDataGathering;                                              // 0x0571 (size: 0x1)
    ...
    uint8 bUseVoxelCache;                                                             // 0x0580 (size: 0x1)
    float TileSetUpdateInterval;                                                      // 0x0584 (size: 0x4)
    float HeuristicScale;                                                             // 0x0588 (size: 0x4)
    float VerticalDeviationFromGroundCompensation;                                    // 0x058C (size: 0x4)
...
{
    TArray<FNavigationLink> Links;                                                    // 0x0568 (size: 0x10)
