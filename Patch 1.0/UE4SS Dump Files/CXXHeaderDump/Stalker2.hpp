...
{
    class USizeBox* ItemImageSizeBox;                                                 // 0x0510 (size: 0x8)
    class UImage* Background;                                                         // 0x0518 (size: 0x8)
    class UTextWidget* StackAmount;                                                   // 0x0520 (size: 0x8)
    class UImage* Broken;                                                             // 0x0528 (size: 0x8)
    class UImage* Attach;                                                             // 0x0530 (size: 0x8)
    int32 MinSlotSize;                                                                // 0x0538 (size: 0x4)
...
{
    class USizeBox* ItemImageSizeBox;                                                 // 0x0408 (size: 0x8)
    class UImage* Background;                                                         // 0x0410 (size: 0x8)
    class UTextWidget* StackAmount;                                                   // 0x0418 (size: 0x8)
    class UImage* Broken;                                                             // 0x0420 (size: 0x8)
    class UImage* Attach;                                                             // 0x0428 (size: 0x8)
    class UImage* Quest;                                                              // 0x0430 (size: 0x8)
    int32 MinSlotSize;                                                                // 0x0438 (size: 0x4)
...
{
    class UImage* Background;                                                         // 0x0510 (size: 0x8)
    class UImage* EffectsHighlight;                                                   // 0x0518 (size: 0x8)
    class UImage* bLocked;                                                            // 0x0520 (size: 0x8)
    class UImage* DefaultImage;                                                       // 0x0528 (size: 0x8)
    class UImage* Broken;                                                             // 0x0530 (size: 0x8)
    class UImage* Attach;                                                             // 0x0538 (size: 0x8)
    class UScaleBox* ItemImageScaleBox;                                               // 0x0540 (size: 0x8)
    class UBorder* HighlightBorder;                                                   // 0x0548 (size: 0x8)
    FLinearColor DefaultImageColor;                                                   // 0x0550 (size: 0x10)
    FWidgetTransform DefaultIconTransform;                                            // 0x0560 (size: 0x38)
    FLinearColor TransparentDefaultImageColor;                                        // 0x0598 (size: 0x10)
    class UTexture2D* DefaultIcon;                                                    // 0x05A8 (size: 0x8)
    class UTexture2D* BackgroundIcon;                                                 // 0x05B0 (size: 0x8)
    class UTexture2D* BlockedIcon;                                                    // 0x05B8 (size: 0x8)
    bool bArtifact;                                                                   // 0x05C0 (size: 0x1)
    float DefaultImageScaleX;                                                         // 0x05C4 (size: 0x4)
    float DefaultImageScaleY;                                                         // 0x05C8 (size: 0x4)
    class UImage* InventoryHighlightImage;                                            // 0x05D0 (size: 0x8)
    class UTexture2D* InventoryHighlightTexture;                                      // 0x05D8 (size: 0x8)
...
{
    TSoftClassPtr<UUserWidget> ModBrowserClass;                                       // 0x0058 (size: 0x30)
    TSoftClassPtr<UUserWidget> ModBrowserLoadingClass;                                // 0x0088 (size: 0x30)
    class UModioSubsystem* ModioSubsystem;                                            // 0x00B8 (size: 0x8)
    class UModioUISubsystem* ModioUISubsystem;                                        // 0x00C0 (size: 0x8)
    class UUserWidget* ModBrowserWidget;                                              // 0x00C8 (size: 0x8)
    class UUserWidget* ModBrowserLoadingWidget;                                       // 0x00D0 (size: 0x8)
...
class UInventoryNew : public UViewBaseExtended
{
    ...
    class UHintInputController* HintLootTakeAll;                                      // 0x03D8 (size: 0x8)
    class UHintInputController* HintSortInventory;                                    // 0x03E0 (size: 0x8)
    class UHintInputController* HintShowContextualMenu;                               // 0x03E8 (size: 0x8)
    class UHintInputController* HintMoveItem;                                         // 0x03F0 (size: 0x8)
    class UHintInputController* HintPlaceItem;                                        // 0x03F8 (size: 0x8)
    class UHintInputController* HintRemoveQuickAccess;                                // 0x0400 (size: 0x8)
    float UseItemHoldTime;                                                            // 0x0408 (size: 0x4)
    float DropItemHoldTime;                                                           // 0x040C (size: 0x4)
    class UUpgradeMenuWidget* UpgradeMenu;                                            // 0x0410 (size: 0x8)
    class UButton* SortButton;                                                        // 0x0418 (size: 0x8)
    class UOverlay* LootOverlay;                                                      // 0x0420 (size: 0x8)
    class UImage* IconTakeAllItems;                                                   // 0x0428 (size: 0x8)
    float TooltipAndHintsPadding;                                                     // 0x0430 (size: 0x4)
    TArray<class UHintInputController*> VisibleStateHints;                            // 0x0438 (size: 0x10)
    TArray<class UHintInputController*> CommonHints;                                  // 0x0448 (size: 0x10)
    class UAkSwitchValue* ItemTypeSwitchValue;                                        // 0x0460 (size: 0x8)
    float TooltipDistance;                                                            // 0x0468 (size: 0x4)
    TMap<class UUserWidget*, class ESlateVisibility> GridVisibilityMap;               // 0x0470 (size: 0x50)
    class UUserWidget* CurrGamepadNavigatedWidget;                                    // 0x04F0 (size: 0x8)
    class UItemDragWidget* DragWidget;                                                // 0x0508 (size: 0x8)
    class UItemDragWidget* DragWidgetGrid;                                            // 0x0510 (size: 0x8)
    float ItemTooltipShowDelay;                                                       // 0x0518 (size: 0x4)
    float ItemTooltipCompareShowDelay;                                                // 0x051C (size: 0x4)
    TSubclassOf<class UItemInfo> ItemTooltipClass;                                    // 0x0520 (size: 0x8)
    TSubclassOf<class UItemDragWidget> DragWidgetClass;                               // 0x0528 (size: 0x8)
    TSubclassOf<class UItemDragWidget> DragGridWidgetClass;                           // 0x0530 (size: 0x8)
    TSubclassOf<class UStackSplittingWidget> StackSplitWidgetClass;                   // 0x0538 (size: 0x8)
    class UStackSplitContextual* StackSplitContextual;                                // 0x0540 (size: 0x8)
    class UStackSplittingWidget* StackSplit;                                          // 0x0548 (size: 0x8)
    FLinearColor ItemBacktDefault;                                                    // 0x0550 (size: 0x10)
    FLinearColor ItemBackOk;                                                          // 0x0560 (size: 0x10)
    FLinearColor ItemBackInterceptOne;                                                // 0x0570 (size: 0x10)
    FLinearColor ItemBackInterceptTwo;                                                // 0x0580 (size: 0x10)
    FLinearColor ItemBackDepend;                                                      // 0x0590 (size: 0x10)
    FLinearColor ItemBackHoveredCompatible;                                           // 0x05A0 (size: 0x10)
    float GamepadNavigationThreshold;                                                 // 0x05C0 (size: 0x4)
    class UWidgetAnimation* RadiationMark;                                            // 0x05C8 (size: 0x8)
    FLinearColor ToggleEquipmentIconColor;                                            // 0x05D0 (size: 0x10)
    FLinearColor OverWeightColor;                                                     // 0x05E0 (size: 0x10)
    FLinearColor NormalWeightColor;                                                   // 0x05F0 (size: 0x10)
    class UUserWidget* RightClickMenuWidget;                                          // 0x0630 (size: 0x8)
    class UInteractableItemSlotBaseWidget* ItemSlotStartedDrag;                       // 0x0698 (size: 0x8)
    class UInteractableItemSlotBaseWidget* CurrGamepadSelectedItem;                   // 0x06A0 (size: 0x8)
    EInventoryEquipmentSlot CurrentCompareSlot;                                       // 0x06D0 (size: 0x1)
    class UEquipmentSlot* EquipmentSlotToCompare;                                     // 0x06D8 (size: 0x8)
    EInventoryEquipmentSlot CurrentCompareItemSlotType;                               // 0x06E0 (size: 0x1)
    TArray<class UCustomGridSlot*> GridSlotsPool;                                     // 0x0BE0 (size: 0x10)
...
class UItemDragWidget : public UItemSlotBaseWidget
{
    class USizeBox* ItemImageSizeBox;                                                 // 0x0408 (size: 0x8)
    class UImage* Background;                                                         // 0x0410 (size: 0x8)
    class UBorder* Border;                                                            // 0x0418 (size: 0x8)
    int32 ReturnEquipSlot;                                                            // 0x0470 (size: 0x4)
...
class UItemSlotBaseWidget : public UWidgetBase
{
    ...
    TArray<class UImageWidget*> AttachesImages;                                       // 0x03E0 (size: 0x10)
...
{
    class UAudioScattererDataAsset* AudioScatterer;                                   // 0x00A8 (size: 0x8)
    TWeakObjectPtr<class ALandscape> Landscape;                                       // 0x00CC (size: 0x8)
    class UAkRtpc* InteriorFlagRTPC;                                                  // 0x00D8 (size: 0x8)
    class UOnAKEventFinished_Proxy* OnAKEventFinished_Proxy;                          // 0x00E0 (size: 0x8)
...
class UStackSplitContextual : public UUserWidget
{
    ...
    class UButton* ArrowLeft;                                                         // 0x02F8 (size: 0x8)
    class UButton* ArrowRight;                                                        // 0x0300 (size: 0x8)
    class UPlatformSwitcherBase* ArrowRightPlatformSwitcher;                          // 0x0308 (size: 0x8)
    class UPlatformSwitcherBase* ArrowLeftPlatformSwitcher;                           // 0x0310 (size: 0x8)
    class UOverlay* MainOverlay;                                                      // 0x0338 (size: 0x8)
    FLinearColor ActiveBarColor;                                                      // 0x03B0 (size: 0x10)
    FLinearColor NonActiveBarColor;                                                   // 0x03C0 (size: 0x10)
...
{
    FString SellLocSID;                                                               // 0x03E0 (size: 0x10)
    FString SellAllLocSID;                                                            // 0x03F0 (size: 0x10)
    FString BuyLocSID;                                                                // 0x0400 (size: 0x10)
    FString BuyAllLocSID;                                                             // 0x0410 (size: 0x10)
    FString ReturnLocSID;                                                             // 0x0420 (size: 0x10)
    FString ReturnAllLocSID;                                                          // 0x0430 (size: 0x10)
    FString SellTitleLocSID;                                                          // 0x0440 (size: 0x10)
    FString BuyTitleLocSID;                                                           // 0x0450 (size: 0x10)
    FString ReturnTitleLocSID;                                                        // 0x0460 (size: 0x10)
...
{
    class UCustomGrid* TraderGridWidget;                                              // 0x1380 (size: 0x8)
    class UCustomGrid* SellGridWidget;                                                // 0x1388 (size: 0x8)
    class UCustomGrid* BuyGridWidget;                                                 // 0x1390 (size: 0x8)
    class UTextWidget* TradeConfirmInfoText;                                          // 0x1398 (size: 0x8)
    class UTextWidget* TradeResultMoney;                                              // 0x13A0 (size: 0x8)
    class UTextWidget* TradeResultWeight;                                             // 0x13A8 (size: 0x8)
    class UTextWidget* TradeResultWeightUnits;                                        // 0x13B0 (size: 0x8)
    class UPlatformSwitcher* TraderButtonSwitcher;                                    // 0x13B8 (size: 0x8)
    class UHintInputController* ButtonHintConfirmTrade;                               // 0x13C0 (size: 0x8)
    class UHintInputController* ButtonHintCancelTrade;                                // 0x13C8 (size: 0x8)
    class UHintInputController* HintBuy;                                              // 0x13D0 (size: 0x8)
    class UHintInputController* HintSell;                                             // 0x13D8 (size: 0x8)
    class UHintInputController* HintReturn;                                           // 0x13E0 (size: 0x8)
...
{
    FLinearColor CantBuyHighlight;                                                    // 0x0570 (size: 0x10)
    FLinearColor DefaultHighlightColor;                                               // 0x0580 (size: 0x10)
...
class UUpgradesSettings : public UDataAsset
{
    ...
    FSlateColor Toggleable;                                                           // 0x006C (size: 0x14)
    FSlateColor ResetUpgrade;                                                         // 0x0080 (size: 0x14)
