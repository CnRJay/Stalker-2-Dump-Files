...
struct FLevelSequenceBindingReference
{
    ...
    FGuid GSCQuestGuid;                                                               // 0x0040 (size: 0x10)
...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02A8 (size: 0x20)
    class ULevelSequencePlayer* SequencePlayer;                                       // 0x02C8 (size: 0x8)
    class ULevelSequence* LevelSequenceAsset;                                         // 0x02D0 (size: 0x8)
    FLevelSequenceCameraSettings CameraSettings;                                      // 0x02D8 (size: 0x2)
    class ULevelSequenceBurnInOptions* BurnInOptions;                                 // 0x02E0 (size: 0x8)
    class UMovieSceneBindingOverrides* BindingOverrides;                              // 0x02E8 (size: 0x8)
    uint8 bAutoPlay;                                                                  // 0x02F0 (size: 0x1)
    uint8 bOverrideInstanceData;                                                      // 0x02F0 (size: 0x1)
    uint8 bReplicatePlayback;                                                         // 0x02F0 (size: 0x1)
    class UObject* DefaultInstanceData;                                               // 0x02F8 (size: 0x8)
    class ULevelSequenceBurnIn* BurnInInstance;                                       // 0x0300 (size: 0x8)
    bool bShowBurnin;                                                                 // 0x0308 (size: 0x1)
