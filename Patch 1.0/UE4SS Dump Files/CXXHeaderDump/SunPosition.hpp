...
class USunPositionFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    void GetSunPosition(float Latitude, float Longitude, float TimeZone, bool bIsDaylightSavingTime, int32 Year, int32 Month, int32 Day, int32 Hours, int32 Minutes, int32 Seconds, FSunPositionData& SunPositionData, int32 Milliseconds);
}; // Size: 0x28
