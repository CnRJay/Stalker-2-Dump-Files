...
{
    int32 BufferSizePerChunk;                                                         // 0x0388 (size: 0x4)
...
{
    TArray<uint8> PreviewImageData;                                                   // 0x0310 (size: 0x10)
    TArray<uint8> ARWorldData;                                                        // 0x0320 (size: 0x10)
    int32 PreviewImageBytesTotal;                                                     // 0x0330 (size: 0x4)
    int32 ARWorldBytesTotal;                                                          // 0x0334 (size: 0x4)
    int32 PreviewImageBytesDelivered;                                                 // 0x0338 (size: 0x4)
    int32 ARWorldBytesDelivered;                                                      // 0x033C (size: 0x4)
...
{
    class UAREnvironmentCaptureProbe* CaptureProbe;                                   // 0x02B0 (size: 0x8)
