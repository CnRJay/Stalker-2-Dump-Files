...
//CROSS-MODULE INCLUDE V2: -ModuleName=ModioUICore -ObjectName=ModioUIAsyncOperationWidget -FallbackName=ModioUIAsyncOperationWidget
//CROSS-MODULE INCLUDE V2: -ModuleName=ModioUICore -ObjectName=ModioUIModInfoReceiver -FallbackName=ModioUIModInfoReceiver
