...
UPrimitiveComponent::UPrimitiveComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bReceivesAttachedDecals = false;
...
void UPrimitiveComponent::SetForeground(bool bInForeground) {
}
...
void UPrimitiveComponent::SetDisableOcclusion(bool bValue) {
}
...
bool UPrimitiveComponent::IsForeground() const {
    return false;
}
