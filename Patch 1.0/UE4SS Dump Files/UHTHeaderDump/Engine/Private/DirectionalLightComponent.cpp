...
UDirectionalLightComponent::UDirectionalLightComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bGSCUseCustomDistribution = false;
    ...
    this->TranslucentForwardShadowFactorMultiplier = 1.00f;
    this->ShadowAmount = 1.00f;
}

void UDirectionalLightComponent::SetTranslucentShadowFactorMultiplier(float NewMultiplier) {
}
