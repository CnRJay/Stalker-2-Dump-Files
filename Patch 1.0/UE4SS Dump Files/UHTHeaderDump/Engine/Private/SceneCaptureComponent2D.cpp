...
USceneCaptureComponent2D::USceneCaptureComponent2D(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->CachedShadowsLightTypesUsesMainViewShadowsInfo = ESceneCaptureCachedShadowsLightTypes::None;
    this->CachedShadowsLightTypesWhichShadowsInfoWillBeUsedByMainView = ESceneCaptureCachedShadowsLightTypes::None;
    this->bCachedDistanceFields = false;
    this->bCacheVolumetricCloudsShadowMaps = false;
}
