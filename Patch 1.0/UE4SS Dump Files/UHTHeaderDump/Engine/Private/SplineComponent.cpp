...
float USplineComponent::GetClampAngleAtSplinePoint(int32 PointIndex) const {
    return 0.0f;
}

float USplineComponent::GetClampAngleAtSplineInputKey(float InKey) const {
    return 0.0f;
}

float USplineComponent::GetClampAngleAtDistanceAlongSpline(float Distance) const {
    return 0.0f;
}
