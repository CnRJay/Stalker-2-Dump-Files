...
UStaticMesh::UStaticMesh() {
    this->bAutoComputeLODScreenSize = true;
    this->bKeepFallbackResourceOnCPU = true;
    ...
    this->bAllowStrippingMeshDistanceField = false;
    this->bStripComplexCollisionForConsole = false;
    this->bHasNavigationData = true;
    this->bUnwalkableSurfaceForNavmesh = false;
    this->bUnwalkableDepthForNavmesh = false;
    ...
    this->BuildingType = EBuildingType::None;
    ...
    this->NaniteMesh = NULL;
    this->NonNaniteMesh = NULL;
}
...
TArray<FName> UStaticMesh::GetSocketNames() const {
    return TArray<FName>();
}
