...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetVolumetricFogQuality(int32 Value);
    
    UFUNCTION(BlueprintCallable)
    void SetVolumetricCloudsQuality(int32 Value);
    ...
    UFUNCTION(BlueprintCallable)
    void SetObjectDetailQuality(int32 Value);
    
    UFUNCTION(BlueprintCallable)
    void SetMotionBlurQuality(int32 Value);
    
    UFUNCTION(BlueprintCallable)
    void SetMaterialQuality(int32 Value);
    
    UFUNCTION(BlueprintCallable)
    void SetHairQuality(int32 Value);
    ...
    UFUNCTION(BlueprintCallable)
    void SetDOFQuality(int32 Value);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetVolumetricFogQuality() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetVolumetricCloudsQuality() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetObjectDetailQuality() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetMotionBlurQuality() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetMaterialQuality() const;
