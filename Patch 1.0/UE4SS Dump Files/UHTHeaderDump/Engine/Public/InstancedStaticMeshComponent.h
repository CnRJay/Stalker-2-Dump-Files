...
#include "CollisionStreamingAgentInterface.h"
...
class ENGINE_API UInstancedStaticMeshComponent : public UStaticMeshComponent, public ISMInstanceManager, public ICollisionStreamingAgentInterface {
    GENERATED_BODY()
public:
    ...
    TArray<FInstanceTransform> PerInstancePrevTransform;
    ...
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 InstanceStartFadeInDistance;
    
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 InstanceEndFadeInDistance;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetCullDistances_ForFoliage(int32 StartCullDistance, int32 EndCullDistance, int32 StartFadeInDistance, int32 EndFadeInDistance);
    
    UFUNCTION(BlueprintCallable)
    void SetCullDistances(int32 StartCullDistance, int32 EndCullDistance);
    
    UFUNCTION(BlueprintCallable)
    void RemoveInstancesRange(int32 Begin, int32 End, bool bMarkRenderStateDirty);
    ...
    UFUNCTION(BlueprintCallable)
    void ClearInstances(bool bCallForSplitMeshes);
    ...
    UFUNCTION(BlueprintCallable)
    void AddInstanceCount(int32 Count, const FTransform& InstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty);
