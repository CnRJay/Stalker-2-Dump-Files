...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Interp, ReplicatedUsing=OnRep_StaticMesh, meta=(AllowPrivateAccess=true))
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bOverrideUnwalkableSurfaceForNavmesh: 1;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bOverrideUnwalkableDepthForNavmesh: 1;
