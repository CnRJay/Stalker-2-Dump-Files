...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetClampAngleAtSplinePoint(int32 PointIndex) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetClampAngleAtSplineInputKey(float InKey) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetClampAngleAtDistanceAlongSpline(float Distance) const;
