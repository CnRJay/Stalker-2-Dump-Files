...
public:
    ...
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bGSCUseCustomDistribution: 1;
    
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<float> ManualSplitDistances;
    ...
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    float TranslucentForwardShadowFactorMultiplier;
    ...
    void SetTranslucentShadowFactorMultiplier(float NewMultiplier);
