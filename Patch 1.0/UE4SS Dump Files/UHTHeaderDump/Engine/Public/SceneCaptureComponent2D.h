...
#include "ESceneCaptureCachedShadowsLightTypes.h"
...
public:
    ...
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ESceneCaptureCachedShadowsLightTypes CachedShadowsLightTypesUsesMainViewShadowsInfo;
    
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ESceneCaptureCachedShadowsLightTypes CachedShadowsLightTypesWhichShadowsInfoWillBeUsedByMainView;
    
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bCachedDistanceFields;
    
    UPROPERTY(AdvancedDisplay, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bCacheVolumetricCloudsShadowMaps;
