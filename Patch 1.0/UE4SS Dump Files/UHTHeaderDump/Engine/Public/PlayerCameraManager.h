...
#include "OnFadeScreenEndedSignatureDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    FOnFadeScreenEndedSignature OnFadeScreenEndEvent;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void StartFOVBlend(const float TargetFOV);
