...
struct FAnimHitData
{
    ...
    float ZombieResurrectRate;                                                        // 0x009C (size: 0x4)
...
struct FAnimHumanFaceData
{
    ...
    bool bShouldEnableAdamAppleAnimations;                                            // 0x0211 (size: 0x1)
...
{
    bool bInCombat;                                                                   // 0x0007 (size: 0x1)
    bool bWounded;                                                                    // 0x0008 (size: 0x1)
    bool bKnockedDown;                                                                // 0x0009 (size: 0x1)
    ...
    bool bIsLegIKPaused;                                                              // 0x0038 (size: 0x1)
...
struct FAnimHumanWeaponConfig
{
    ...
    FVector HandIKEffectorOffset;                                                     // 0x0008 (size: 0x18)
...
{
    bool bRotating;                                                                   // 0x0007 (size: 0x1)
    bool bStandToSit;                                                                 // 0x0008 (size: 0x1)
    bool bIsLeftHanded;                                                               // 0x0009 (size: 0x1)
...
struct FAnimPlayerAutoCoverData
{
    ...
    FVector CapturedSideTraceStart;                                                   // 0x0008 (size: 0x18)
    bool bCanCaptureSideTrace;                                                        // 0x0020 (size: 0x1)
    bool bInCover;                                                                    // 0x0021 (size: 0x1)
    bool bAutoCoverActionActive;                                                      // 0x0022 (size: 0x1)
    float AimLeanTime;                                                                // 0x0024 (size: 0x4)
    float ApproachTransitionPlayRate;                                                 // 0x0028 (size: 0x4)
    float LeaningAlpha;                                                               // 0x002C (size: 0x4)
    float LeaningRightAlpha;                                                          // 0x0030 (size: 0x4)
    float LeaningLeftAlpha;                                                           // 0x0034 (size: 0x4)
    bool bCanChangeLeanSide;                                                          // 0x0038 (size: 0x1)
    bool bCoverlessLeaning;                                                           // 0x0039 (size: 0x1)
    bool bCoverlessLeaningRight;                                                      // 0x003A (size: 0x1)
    float MinRangeDistanceToCover;                                                    // 0x003C (size: 0x4)
    float TraceCapsuleRadius;                                                         // 0x0040 (size: 0x4)
    float CoverForwardTraceRange;                                                     // 0x0044 (size: 0x4)
...
{
    bool bWalkingOverride;                                                            // 0x0007 (size: 0x1)
    bool bCrouching;                                                                  // 0x0008 (size: 0x1)
    bool bLowCrouching;                                                               // 0x0009 (size: 0x1)
    bool bClimbing;                                                                   // 0x000A (size: 0x1)
    bool bLimping;                                                                    // 0x000B (size: 0x1)
    bool bShootingUnfocusableTarget;                                                  // 0x000C (size: 0x1)
    bool bDragDeadBody;                                                               // 0x000D (size: 0x1)
    bool bActionSlotActive;                                                           // 0x000E (size: 0x1)
    bool bFullBodySlotActive;                                                         // 0x000F (size: 0x1)
    bool bIsLeftHandBusy;                                                             // 0x0010 (size: 0x1)
    bool bIsInspectingItem;                                                           // 0x0011 (size: 0x1)
    bool bCrouchingOverride;                                                          // 0x0012 (size: 0x1)
    bool bLowCrouchingOverride;                                                       // 0x0013 (size: 0x1)
    bool bSprintingOverride;                                                          // 0x0014 (size: 0x1)
    bool bInAirOverride;                                                              // 0x0015 (size: 0x1)
    float CrouchingInWaterInterruptionTime;                                           // 0x0018 (size: 0x4)
    float SprintingInWaterInterruptionTime;                                           // 0x001C (size: 0x4)
    float InAirInWaterInterruptionTime;                                               // 0x0020 (size: 0x4)
    float CombatIdleDuration;                                                         // 0x0024 (size: 0x4)
    bool bCombatMoveIdle;                                                             // 0x0028 (size: 0x1)
    bool bCombatCrouchIdle;                                                           // 0x0029 (size: 0x1)
    bool bCombatActionActive;                                                         // 0x002A (size: 0x1)
    float CombatIdleCooldown;                                                         // 0x002C (size: 0x4)
    bool bForceBindedHandsLookVertical;                                               // 0x0030 (size: 0x1)
    bool bHasExoskeleton;                                                             // 0x0031 (size: 0x1)
    float CurveGaitValue;                                                             // 0x0034 (size: 0x4)
    float DynamicGaitValue;                                                           // 0x0038 (size: 0x4)
    EAnimationStates EnumGaitState;                                                   // 0x003C (size: 0x1)
...
struct FAnimStateData
{
    ...
    bool bCutscene;                                                                   // 0x0006 (size: 0x1)
...
{
    bool HandleAsync;                                                                 // 0x0000 (size: 0x1)
    TArray<class UAsyncActionBase*> OnLoadingStart;                                   // 0x0008 (size: 0x10)
    TArray<class UAsyncActionBase*> OnLoadingFinished;                                // 0x0018 (size: 0x10)
...
struct FGameGraphSceneProxyDrawParams
{
    ...
    bool bEnableComponentColoring;                                                    // 0x0002 (size: 0x1)
    bool bEnablePolyBindConnectivityColoring;                                         // 0x0003 (size: 0x1)
    bool bDebugContextualActions;                                                     // 0x0004 (size: 0x1)
    int32 PolyBindConnectivityNavDataIdx;                                             // 0x0008 (size: 0x4)
    FColor DefaultGGColor;                                                            // 0x000C (size: 0x4)
...
struct FHintControllerSettings
{
    ...
    FAsyncSettings AsyncSettings;                                                     // 0x0028 (size: 0x28)
...
{
    class UPhysicsSoundsComponent* PhysicsSoundsComponent;                            // 0x0960 (size: 0x8)
    class UNPCComponent* NPCComponent;                                                // 0x09A8 (size: 0x8)
    class UPhysicsInteractionComponent* PhysicsInteractionComponent;                  // 0x09B0 (size: 0x8)
    class UWoundedHoldComponent* WoundedHoldComponent;                                // 0x09B8 (size: 0x8)
    class UTouchComponent* TouchComponent;                                            // 0x09C0 (size: 0x8)
    class UMotionWarpingComponent* MotionWarpingComponent;                            // 0x09C8 (size: 0x8)
    class UAITickComponent* AITickComponent;                                          // 0x09D0 (size: 0x8)
    class UPhysicsControlComponent* PhysicsControlComponent;                          // 0x09D8 (size: 0x8)
    class ULODSyncComponent* LODSyncComponent;                                        // 0x09E0 (size: 0x8)
    class UDataLayerPhysicsComponent* DataLayerPhysicsComponent;                      // 0x09E8 (size: 0x8)
    class UDeadBody* DeadBodyComponent;                                               // 0x09F0 (size: 0x8)
    FDamageInteractVFXData DamageInteractVFXData;                                     // 0x09F8 (size: 0x10)
    FName AttachDamageInteractVFXBoneName;                                            // 0x0A08 (size: 0x8)
    class AActor* CutsceneLookAtActor;                                                // 0x0A10 (size: 0x8)
    float CutsceneEyesLookAtWeight;                                                   // 0x0A18 (size: 0x4)
    float CutsceneHeadLookAtWeight;                                                   // 0x0A1C (size: 0x4)
    ECutsceneBlinkProfile CutsceneBlinkProfile;                                       // 0x0A20 (size: 0x1)
    ECutsceneEyesIdleProfile CutsceneEyesIdleProfile;                                 // 0x0A21 (size: 0x1)
    float CutsceneProceduralEyesWeight;                                               // 0x0A24 (size: 0x4)
    float CutsceneProceduralEyesAmplitude;                                            // 0x0A28 (size: 0x4)
    float CutsceneProceduralEyesIntensity;                                            // 0x0A2C (size: 0x4)
    float GuaranteedRelevancyUpdateTime;                                              // 0x0A30 (size: 0x4)
    FName RagdollProfileName;                                                         // 0x0A34 (size: 0x8)
    TArray<FName> RagdollBonesToOverlap;                                              // 0x0A40 (size: 0x10)
...
{
    class USphereComponent* SphereComponent;                                          // 0x02C8 (size: 0x8)
    class UNiagaraComponent* StrafeParticle;                                          // 0x02D0 (size: 0x8)
    class UArtifactInteractableComponent* ArtifactInteractableComponent;              // 0x02D8 (size: 0x8)
    class UPhysicsInteractionComponent* PhysicsInteractionComponent;                  // 0x02E0 (size: 0x8)
    class UPhysicsSoundsComponent* PhysicsSoundsComponent;                            // 0x02E8 (size: 0x8)
    bool bDetectorRequired;                                                           // 0x02F0 (size: 0x1)
    class UAkAudioEvent* ChargingEvent;                                               // 0x0308 (size: 0x8)
    class UAkAudioEvent* JumpEvent;                                                   // 0x0310 (size: 0x8)
    class UAkAudioEvent* Sound;                                                       // 0x0318 (size: 0x8)
    class UAkAudioEvent* SoundStop;                                                   // 0x0320 (size: 0x8)
    class UAkAudioEvent* SoundStateTransitionOnHide;                                  // 0x0328 (size: 0x8)
    class UAkAudioEvent* SoundStateTransitionOnShow;                                  // 0x0330 (size: 0x8)
    class UAkSwitchValue* ArtifactTypeSwitchValue;                                    // 0x0338 (size: 0x8)
    class UFXSystemAsset* ParticleOnShow;                                             // 0x0340 (size: 0x8)
    class UAkAudioEvent* FakeArtifactDistortionSound;                                 // 0x0348 (size: 0x8)
    class UFXSystemAsset* FakeArtifactDistortionVFX;                                  // 0x0350 (size: 0x8)
    class UFXSystemAsset* FakeArtifactDissolveVFX;                                    // 0x0358 (size: 0x8)
    class UDataLayerPhysicsComponent* DataLayerPhysicsComponent;                      // 0x0360 (size: 0x8)
    class UNiagaraSystem* ParticleStateTransitionFadeIn;                              // 0x0368 (size: 0x8)
    class UNiagaraSystem* ParticleStateTransitionFadeOut;                             // 0x0370 (size: 0x8)
    class UNiagaraSystem* ParticleOnImpact;                                           // 0x0378 (size: 0x8)
    class UFXSystemComponent* ActiveParticleOnShow;                                   // 0x03C8 (size: 0x8)
...
{
    class UNiagaraComponent* InvisibilityTransferParticles;                           // 0x0AD0 (size: 0x8)
...
class ADoorView : public AUIDActor_Door
{
    ...
    int32 NumberOfDoorHinges;                                                         // 0x04B8 (size: 0x4)
    class USceneComponent* DefaultRoot;                                               // 0x04C0 (size: 0x8)
    class UStaticMeshComponent* FrameMeshComponent;                                   // 0x04C8 (size: 0x8)
    class UStaticMeshComponent* FirstLeafMeshComponent;                               // 0x04D0 (size: 0x8)
    class UStaticMeshComponent* SecondLeafMeshComponent;                              // 0x04D8 (size: 0x8)
    class UPhysicsConstraintComponent* FirstLeafPhysicsConstraintComponent;           // 0x04E0 (size: 0x8)
    class UPhysicsConstraintComponent* SecondLeafPhysicsConstraintComponent;          // 0x04E8 (size: 0x8)
    class UHittableComponent* HittableComponent;                                      // 0x04F0 (size: 0x8)
    class UGSCNavModifierComponent* SpaceRestrictorComponent;                         // 0x04F8 (size: 0x8)
    class UBoxComponent* BlockVolume;                                                 // 0x0500 (size: 0x8)
    class USignalReceiverComponent* InvertDoorStateReceiver;                          // 0x0508 (size: 0x8)
    class USignalReceiverComponent* InvertDoorLockReceiver;                           // 0x0510 (size: 0x8)
    class USignalReceiverComponent* OpenDoorReceiver;                                 // 0x0518 (size: 0x8)
    class USignalReceiverComponent* CloseDoorReceiver;                                // 0x0520 (size: 0x8)
    class USignalReceiverComponent* LockDoorReceiver;                                 // 0x0528 (size: 0x8)
    class USignalReceiverComponent* UnlockDoorReceiver;                               // 0x0530 (size: 0x8)
    class USignalReceiverComponent* PeekDoorReceiver;                                 // 0x0538 (size: 0x8)
    class USignalReceiverComponent* ForceOpenDoorReceiver;                            // 0x0540 (size: 0x8)
    class USignalReceiverComponent* ForceCloseDoorReceiver;                           // 0x0548 (size: 0x8)
    class USignalSenderComponent* OpenDoorSender;                                     // 0x0550 (size: 0x8)
    class USignalSenderComponent* CloseDoorSender;                                    // 0x0558 (size: 0x8)
    class USignalSenderComponent* LockDoorSender;                                     // 0x0560 (size: 0x8)
    class USignalSenderComponent* UnlockDoorSender;                                   // 0x0568 (size: 0x8)
    class USignalSenderComponent* ForceOpenDoorSender;                                // 0x0570 (size: 0x8)
    class USignalSenderComponent* ForceCloseDoorSender;                               // 0x0578 (size: 0x8)
    class USignalSenderComponent* PeekDoorSender;                                     // 0x0580 (size: 0x8)
    class UItemUsageComponent* ItemUsageComponent;                                    // 0x0588 (size: 0x8)
    class UAkComponent* FirstLeafAkComponent;                                         // 0x0590 (size: 0x8)
    class UAkComponent* SecondLeafAkComponent;                                        // 0x0598 (size: 0x8)
    TSoftObjectPtr<UAkAudioEvent> DoorMovementSFX;                                    // 0x05A0 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> DoorConstraintSFX;                                  // 0x05D0 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> DoorOpenSFX;                                        // 0x0600 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> DoorCloseSFX;                                       // 0x0630 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> UnlockDoorSFX;                                      // 0x0660 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> LockedDoorSFX;                                      // 0x0690 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> SilentDoorOpenSFX;                                  // 0x06C0 (size: 0x30)
    TSoftObjectPtr<UAkAudioEvent> KnockDoorOpenSFX;                                   // 0x06F0 (size: 0x30)
    TSoftObjectPtr<UAkRtpc> DoorMovementRTPC;                                         // 0x0720 (size: 0x30)
...
class AObj : public AModelCharacter
{
    ...
    TArray<FHitBlocker> HitBlockers;                                                  // 0x07D0 (size: 0x10)
    class UMovementComponentExt* MovementComponentExt;                                // 0x07E0 (size: 0x8)
    class UPhysicalAnimationComponent* PhysicalAnimationComponent;                    // 0x07E8 (size: 0x8)
    class UObjWaterContactController* WaterContactController;                         // 0x07F0 (size: 0x8)
    class ULaserSightComponent* LaserSightComponent;                                  // 0x07F8 (size: 0x8)
    class UCurveVector* FallingDamageCurve;                                           // 0x0800 (size: 0x8)
    class UAkAudioEvent* FallingDamageSound;                                          // 0x0808 (size: 0x8)
    class UAkSwitchValue* FallingDamageEasySoundSwitch;                               // 0x0810 (size: 0x8)
    class UAkSwitchValue* FallingDamageMediumSoundSwitch;                             // 0x0818 (size: 0x8)
    class UAkSwitchValue* FallingDamageHighSoundSwitch;                               // 0x0820 (size: 0x8)
    FCollisionProfileName CutsceneCollisionProfile;                                   // 0x0828 (size: 0x8)
    class UDataTable* AkComponentRetargetTable;                                       // 0x0848 (size: 0x8)
    class UAttackComponent* AttackComponent;                                          // 0x08A0 (size: 0x8)
    class UHeadFlashlightComponent* FlashlightComponent;                              // 0x08A8 (size: 0x8)
    class UAkComponent* AkAudioRootComponent;                                         // 0x08B0 (size: 0x8)
    class UAkComponent* AkAudioHeadComponent;                                         // 0x08B8 (size: 0x8)
    class UAkComponent* AkAudioPelvisComponent;                                       // 0x08C0 (size: 0x8)
    class UAkComponent* AkAudioLeftHandComponent;                                     // 0x08C8 (size: 0x8)
    class UAkComponent* AkAudioRightHandComponent;                                    // 0x08D0 (size: 0x8)
    class UAkComponent* AkAudioComponent;                                             // 0x08D8 (size: 0x8)
    class UNiagaraComponent* ShootingParticle;                                        // 0x08E0 (size: 0x8)
    class UNiagaraComponent* PostShootingParticle;                                    // 0x08E8 (size: 0x8)
...
{
    TSoftObjectPtr<UPlayerItemsSounds> PlayerItemSounds;                              // 0x0960 (size: 0x30)
    class UMouthComponent* Mouth;                                                     // 0x09A8 (size: 0x8)
    class UDamageVoiceoverComponent* DamageVoiceover;                                 // 0x09B0 (size: 0x8)
    class UAimAssistComponent* AimAssistComponent;                                    // 0x09B8 (size: 0x8)
    class UAimProcessorComponent* AimProcessor;                                       // 0x09C0 (size: 0x8)
    class USkeletalMeshComponent* ShadowMeshComponent;                                // 0x09C8 (size: 0x8)
    class UGeigerCounterComponent* GeigerCounterComponent;                            // 0x09D0 (size: 0x8)
    class UPsyNoiseSFXComponent* PsyNoiseSFXComponent;                                // 0x09D8 (size: 0x8)
    class UAnomalyDetectorComponent* AnomalyDetectorComponent;                        // 0x09E0 (size: 0x8)
    class UPlayerOpticScopeComponent* PlayerOpticScopeComponent;                      // 0x09E8 (size: 0x8)
    class UPlayerInteractionComponent* PlayerInteractionComponent;                    // 0x09F0 (size: 0x8)
    class UStealthKillComponent* StealthKillComponent;                                // 0x09F8 (size: 0x8)
    class AActor* StealthKillTarget;                                                  // 0x0A00 (size: 0x8)
    class USearchpointDetectorComponent* SearchpointDetectorComponent;                // 0x0A08 (size: 0x8)
    class UGAPlayerComponent* GAComponent;                                            // 0x0A10 (size: 0x8)
    bool InteractionFromBluerint;                                                     // 0x0F48 (size: 0x1)
    double MinObjectInteractImpulse;                                                  // 0x0F50 (size: 0x8)
    double MaxObjectInteractImpulse;                                                  // 0x0F58 (size: 0x8)
    double ObjectInteractDelay;                                                       // 0x0F60 (size: 0x8)
    double MinSpeedToObjectResponse;                                                  // 0x0F68 (size: 0x8)
    float NormalReapeatFPS;                                                           // 0x0F70 (size: 0x4)
    float VelocityMultimplier;                                                        // 0x0F74 (size: 0x4)
    class UCurveFloat* ObjectPenetrationToImpulseCurve;                               // 0x0F78 (size: 0x8)
    class UCurveFloat* ObjectMassToImpulseCurve;                                      // 0x0F80 (size: 0x8)
    class UCurveFloat* ObjectMassToMaxImpulseCurve;                                   // 0x0F88 (size: 0x8)
    class UCurveFloat* ReduceDamageFromNPCCurve;                                      // 0x0F90 (size: 0x8)
    EPlayerMovementType AllowedMovementActions;                                       // 0x0FA0 (size: 0x1)
    class UAkRtpc* PoppyFieldSleepinessParameter;                                     // 0x1060 (size: 0x8)
...
{
    class UNiagaraComponent* BodyParticles;                                           // 0x0AD0 (size: 0x8)
    class USphereComponent* BodyCollision;                                            // 0x0AD8 (size: 0x8)
    class UNiagaraComponent* DeathParticles;                                          // 0x0AE0 (size: 0x8)
    FVector MeshSpawnOffset;                                                          // 0x0AE8 (size: 0x18)
    TMap<EDamageType, float> DeathImpulseScaleMap;                                    // 0x0B00 (size: 0x50)
    float DeathBodyVisibilityDelay;                                                   // 0x0B50 (size: 0x4)
...
{
    class UAkRtpc* RatUnitsAmount;                                                    // 0x0AD0 (size: 0x8)
    class UAkRtpc* LocomotionUnitsAmount;                                             // 0x0AD8 (size: 0x8)
    class UAkRtpc* DiedUnitsAmount;                                                   // 0x0AE0 (size: 0x8)
    class UAkAudioEvent* RatVoice;                                                    // 0x0AE8 (size: 0x8)
    class UAkAudioEvent* RatLocomotionVoice;                                          // 0x0AF0 (size: 0x8)
    class UAkSwitchValue* AlertState;                                                 // 0x0AF8 (size: 0x8)
    class UAkSwitchValue* AttackState;                                                // 0x0B00 (size: 0x8)
    class UAkSwitchValue* EatingState;                                                // 0x0B08 (size: 0x8)
    class UAkSwitchValue* IdleState;                                                  // 0x0B10 (size: 0x8)
    class UAISwarmComponent* RatsMeshComponent;                                       // 0x0B18 (size: 0x8)
...
class IAsyncMixin : public IInterface
{
}; // Size: 0x28
...
{
    FAnimHumanStateData StateData;                                                    // 0x0400 (size: 0x3C)
    FAnimHumanFaceData FaceData;                                                      // 0x0440 (size: 0x220)
    FAnimWoundedData WoundedData;                                                     // 0x0660 (size: 0x48)
    FAnimSleepData SleepData;                                                         // 0x06A8 (size: 0x1)
    FAnimCutsceneData CutsceneData;                                                   // 0x06AC (size: 0x8)
...
class UAnimInstanceHuman : public UAnimInstanceBase
{
    ...
    FAnimHumanStateData StateData;                                                    // 0x06E8 (size: 0x3C)
    FAnimTwoHandsIKData HandsIKData;                                                  // 0x0728 (size: 0x78)
    FAnimHumanFaceData FaceData;                                                      // 0x07A0 (size: 0x220)
    FAnimHumanLookAtData LookAtData;                                                  // 0x09C0 (size: 0x1B0)
    FAnimHumanDialogData DialogData;                                                  // 0x0B70 (size: 0x78)
    FAnimPoseSearchLocomotionData PoseSearchLocomotionData;                           // 0x0BF0 (size: 0x1D0)
    FAnimPhysicalData PhysicalData;                                                   // 0x0DC0 (size: 0x3D8)
    FTwoLegIKData LegsData;                                                           // 0x1198 (size: 0x28)
    FAnimCutsceneData CutsceneData;                                                   // 0x11C0 (size: 0x8)
    class UAnimSequenceBase* LastGestureAnimation;                                    // 0x11C8 (size: 0x8)
    FAnimAbilityData AbilityData;                                                     // 0x11D0 (size: 0x18)
...
class UAnimInstancePlayer : public UAnimInstanceBase
{
    ...
    FAnimPlayerStateData StateData;                                                   // 0x06B0 (size: 0x40)
    ...
    FAnimPlayerDialogData DialogData;                                                 // 0x1340 (size: 0x8)
    FAnimPlayerUnfocusableTargetData AnimPlayerUnfocusableTargetData;                 // 0x1348 (size: 0x1)
    FAnimPlayerVaultingData VaultingData;                                             // 0x1350 (size: 0xB8)
    FAnimPlayerShadowData ShadowData;                                                 // 0x1408 (size: 0x30)
    FAnimPlayerStealthData StealthData;                                               // 0x1438 (size: 0x20)
    FAnimCutsceneData CutsceneData;                                                   // 0x1458 (size: 0x8)
...
class UAnimInstancePlayerShadow : public UAnimInstanceBase
{
    ...
    FAnimPlayerStateData StateData;                                                   // 0x0430 (size: 0x40)
...
{
    bool bUseBlendShapeAnimations;                                                    // 0x06B8 (size: 0x1)
...
{
    bool bIsBlendIn;                                                                  // 0x0080 (size: 0x1)
    EAlphaBlendOption BlendOption;                                                    // 0x0081 (size: 0x1)
    class UCurveFloat* CustomCurve;                                                   // 0x0088 (size: 0x8)
    bool bShouldBlendWeaponInHands;                                                   // 0x0090 (size: 0x1)
...
{
    FName WarpTargetName;                                                             // 0x0080 (size: 0x8)
    bool bShouldExcludeWarpTargetAfterComplete;                                       // 0x0088 (size: 0x1)
...
{
    float LoopTimeCompareTolerance;                                                   // 0x0080 (size: 0x4)
...
{
    EClothSimulationState ClothSimState;                                              // 0x0040 (size: 0x1)
...
class UAnimationUtilitiesBPFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    bool IsSimulationEnable(class UObject* Object, class UGroomAsset* GroomAsset);
...
class UAsyncHintBox : public UWidgetBase
{
    float SpaceBetweenHints;                                                          // 0x02A0 (size: 0x4)
    class UHorizontalBox* HorizontalBox;                                              // 0x02A8 (size: 0x8)
    TArray<class UHintControllerBase*> LegendButtonList;                              // 0x02B0 (size: 0x10)

}; // Size: 0x2C0

class UAsyncVisibilityAction : public UAsyncActionBase
{
    ESlateVisibility Visibility;                                                      // 0x0028 (size: 0x1)
...
{
    class USaveLoadIO* SaveLoadIO;                                                    // 0x0118 (size: 0x8)
...
class UCustomConsoleManagerIK : public UBaseConsoleManager
{
    ...
    void XSkipTimeHours(const float Hours);
...
class UCustomConsoleManagerMP : public UBaseConsoleManager
{
    ...
    void XToggleShowDebugStealthKill();
...
class UGameGraphRenderingComponent : public UDebugDrawComponent
{
    ...
    FGameGraphSceneProxyDrawParams DrawParams;                                        // 0x05B8 (size: 0x10)
    class UMaterialInstance* GameGraphMaterial;                                       // 0x05C8 (size: 0x8)
    FBoxSphereBounds GameGraphBoundsBox;                                              // 0x05D0 (size: 0x38)
...
class UGameSettingsWidget : public USettingsPage
{
    ...
    class USettingElementOnOff* SendAnalyticsData;                                    // 0x02C8 (size: 0x8)
...
{
    bool bInitializeAutomatically;                                                    // 0x02A0 (size: 0x1)
    FHintControllerSettings ControllerSettings;                                       // 0x02A8 (size: 0x50)
    FHintStyleSettings StyleSettings;                                                 // 0x02F8 (size: 0x28)
    class UPlatformSwitcherBase* PlatformSwitcher;                                    // 0x0320 (size: 0x8)
    class UTextWidget* LeftText;                                                      // 0x0328 (size: 0x8)
    class USpacer* LeftGap;                                                           // 0x0330 (size: 0x8)
    class UTextWidget* RightText;                                                     // 0x0338 (size: 0x8)
    class USpacer* RightGap;                                                          // 0x0340 (size: 0x8)
...
{
    EInputIconsType InputIconsType;                                                   // 0x02A0 (size: 0x1)

}; // Size: 0x2A8

class UHintImageGamepad : public UHintImageBase
{
    class UImage* HintImage;                                                          // 0x02A8 (size: 0x8)
...
{
    class UImage* HintImage;                                                          // 0x02A8 (size: 0x8)
    class UImage* HintBackground;                                                     // 0x02B0 (size: 0x8)
    class URichTextBlock* HintChar;                                                   // 0x02B8 (size: 0x8)
    FString KeyboardCharStyle;                                                        // 0x02C0 (size: 0x10)
    FName BackgroundName;                                                             // 0x02D0 (size: 0x8)

}; // Size: 0x2D8

class UHintInputController : public UHintControllerBase
{
    class UActionMimicButton* MimicButtonElement;                                     // 0x0348 (size: 0x8)
    bool bHandleMouseInput;                                                           // 0x0350 (size: 0x1)
...
{
    float IntervalClick;                                                              // 0x0348 (size: 0x4)
    float IntervalHold;                                                               // 0x034C (size: 0x4)
...
{
    bool bInitializeAutomatically;                                                    // 0x02A0 (size: 0x1)
    FHintViewSettings HintViewSettings;                                               // 0x02A4 (size: 0x20)
    class UHintImageBase* HintIconImage;                                              // 0x02C8 (size: 0x8)
    class UHintImageBase* HintIconImageDisabled;                                      // 0x02D0 (size: 0x8)
    class UImage* ProgressMaterial;                                                   // 0x02D8 (size: 0x8)
    class USizeBox* ViewSizeBox;                                                      // 0x02E0 (size: 0x8)
    class UScaleBox* ViewScaleBox;                                                    // 0x02E8 (size: 0x8)
    class UWidgetAnimation* PressAnimation;                                           // 0x02F0 (size: 0x8)
    float PressAnimationSpeedMultiplier;                                              // 0x02F8 (size: 0x4)
    TMap<class EHintProgressType, class FProgressMaterialData> ProgressMaterialMap;   // 0x0300 (size: 0x50)
...
{
    class UImage* IconImage;                                                          // 0x0350 (size: 0x8)
    TMap<class EInteractionTypeIcon, class TSoftObjectPtr<UTexture2D>> InteractionTypeIcons; // 0x0358 (size: 0x50)
...
class UInteractView : public UViewBase
{
    ...
    class UCanvasPanel* HintCanvas;                                                   // 0x02D8 (size: 0x8)
    class UCanvasPanel* InteractCanvas;                                               // 0x02E0 (size: 0x8)
    class UTextWidget* NameText;                                                      // 0x02E8 (size: 0x8)
    class UTextWidget* ActionText;                                                    // 0x02F0 (size: 0x8)
    class UTextWidget* SecondActionText;                                              // 0x02F8 (size: 0x8)
    class UOverlay* MainActionElement;                                                // 0x0300 (size: 0x8)
    class UOverlay* SecondActionElement;                                              // 0x0308 (size: 0x8)
    class UOverlay* NameElement;                                                      // 0x0310 (size: 0x8)
    class UImage* UpgradeIcon;                                                        // 0x0318 (size: 0x8)
    class UImage* DurabilityIcon;                                                     // 0x0320 (size: 0x8)
    class UImage* OverweightIcon;                                                     // 0x0328 (size: 0x8)
    class UImage* MainRightSoftTile;                                                  // 0x0330 (size: 0x8)
    FVector2D InteractItemOffset;                                                     // 0x0338 (size: 0x10)
    TArray<TWeakObjectPtr<UInteractionComponent>> InteractionComponents;              // 0x0348 (size: 0x10)
    TArray<class UInteractHintInputController*> HintWidgets;                          // 0x0358 (size: 0x10)
    FString UpgradesBlueprintL10n;                                                    // 0x0390 (size: 0x10)
...
class UInventoryNew : public UViewBaseExtended
{
    ...
    class UItemInfo* ItemTooltip;                                                     // 0x0300 (size: 0x8)
    class UItemCompareWidget* ItemCompareWidget;                                      // 0x0308 (size: 0x8)
    ...
    class UInteractableItemSlotBaseWidget* ItemSlotStartedDrag;                       // 0x06A8 (size: 0x8)
    class UInteractableItemSlotBaseWidget* CurrGamepadSelectedItem;                   // 0x06B0 (size: 0x8)
    EInventoryEquipmentSlot CurrentCompareSlot;                                       // 0x06E0 (size: 0x1)
    class UEquipmentSlot* EquipmentSlotToCompare;                                     // 0x06E8 (size: 0x8)
    EInventoryEquipmentSlot CurrentCompareItemSlotType;                               // 0x06F0 (size: 0x1)
    TArray<class UCustomGridSlot*> GridSlotsPool;                                     // 0x0BF0 (size: 0x10)
...
class UItemCompareWidget : public UWidgetBase
{
    class UItemInfo* PrimaryItemInfo;                                                 // 0x0278 (size: 0x8)
    class UItemInfo* SecondaryItemInfo;                                               // 0x0280 (size: 0x8)
    class UItemEquippedWidget* ItemEquippedWidget;                                    // 0x0288 (size: 0x8)
    class UWidgetAnimation* ToggleAnimation;                                          // 0x0290 (size: 0x8)
    float AnimationPlayRate;                                                          // 0x0298 (size: 0x4)
    FString PrimaryWeaponSID;                                                         // 0x02A0 (size: 0x10)
    FString SecondaryWeaponSID;                                                       // 0x02B0 (size: 0x10)
...
class UItemEquippedWidget : public UWidgetBase
{
    class UImage* SwapIcon;                                                           // 0x0278 (size: 0x8)
    class UTextBlock* WeaponTextBox;                                                  // 0x0280 (size: 0x8)
    class UTextBlock* EquippedTextBox;                                                // 0x0288 (size: 0x8)
    FString EquippedSID;                                                              // 0x0290 (size: 0x10)
...
class UMapSettingsAsset : public UDataAsset
{
    ...
    float MarkerUntrackDistance;                                                      // 0x012C (size: 0x4)
...
{
    class UAsyncHintBox* LegendSubViewPanel;                                          // 0x0278 (size: 0x8)
    class UAsyncHintBox* LegendButtonPanel;                                           // 0x0280 (size: 0x8)
    TArray<class UHintControllerBase*> LegendSubViewWidgets;                          // 0x0288 (size: 0x10)
    TArray<class UHintControllerBase*> LegendButtonWidgets;                           // 0x0298 (size: 0x10)
...
{
    class UModioSearchField* SearchField;                                             // 0x02B8 (size: 0x8)
    FModioLegendData LegendData;                                                      // 0x02C0 (size: 0x10)
...
{
    class UNiagaraComponent* Niagara;                                                 // 0x00F0 (size: 0x8)
    FName SplashSpawnRateParamName;                                                   // 0x00F8 (size: 0x8)
    FName DropSpawnRateParamName;                                                     // 0x0100 (size: 0x8)
...
class UPDATutorialPanel : public UPDASlotPanelBase
{
    ...
    TMap<class EPDATutorialCategory, class FSlotFilterSettings> SlotFilterSettings;   // 0x0310 (size: 0x50)
...
class UPlayerDetectorAnimCollection : public UObject
{
    ...
    FCharacterDetectorAnimations UnequipFast;                                         // 0x00F8 (size: 0x68)
    FCharacterDetectorAnimations EquipBothHands;                                      // 0x0160 (size: 0x68)
    FCharacterDetectorWeaponAnimations WeaponSwitch;                                  // 0x01C8 (size: 0x8)
    FCharacterDetectorWeaponAnimations WeaponShoot;                                   // 0x01D0 (size: 0x8)
    FCharacterDetectorWeaponAnimations WeaponAimShoot;                                // 0x01D8 (size: 0x8)
    FCharacterDetectorFailedLandingAnimations FailedLanding;                          // 0x01E0 (size: 0x50)
    FDetectorToggleFlashlightAnimations ToggleFlashlight;                             // 0x0230 (size: 0x50)
    UClass* PlayerAnimBlueprint;                                                      // 0x0280 (size: 0x8)
    FAnimWeaponSwingContainer SwingConfigContainer;                                   // 0x0288 (size: 0x38)
    FWeaponInertiaContainer StopSwingInertia;                                         // 0x02C0 (size: 0x20)
    FWeaponInertiaContainer StopSprintInertia;                                        // 0x02E0 (size: 0x20)
...
{
    class UAkAudioEvent* FloatingStartSound;                                          // 0x0698 (size: 0x8)
    class UAkAudioEvent* FloatingStopSound;                                           // 0x06A0 (size: 0x8)
    class UNiagaraSystem* FloatingVFX;                                                // 0x06A8 (size: 0x8)
    class UNiagaraComponent* FloatingVFXComponent;                                    // 0x06B0 (size: 0x8)
    class UAkComponent* SoundComponent;                                               // 0x06B8 (size: 0x8)
...
{
    float DefaultWrapText;                                                            // 0x02E0 (size: 0x4)
    FText DefaultText;                                                                // 0x02E8 (size: 0x18)
    bool bUseWrappingFromStyle;                                                       // 0x0300 (size: 0x1)
    bool bEnableStyleManager;                                                         // 0x0301 (size: 0x1)
    FTextSettings TextSettings;                                                       // 0x0310 (size: 0x3C0)
    bool bEnableScroll;                                                               // 0x06D0 (size: 0x1)
    class UCommonTextBlock* CommonTextObj;                                            // 0x06D8 (size: 0x8)
    FSlotScaleSettings TextScaleSettings;                                             // 0x06E0 (size: 0x14)
...
{
    class UCustomGrid* TraderGridWidget;                                              // 0x1390 (size: 0x8)
    class UCustomGrid* SellGridWidget;                                                // 0x1398 (size: 0x8)
    class UCustomGrid* BuyGridWidget;                                                 // 0x13A0 (size: 0x8)
    class UTextWidget* TradeConfirmInfoText;                                          // 0x13A8 (size: 0x8)
    class UTextWidget* TradeResultMoney;                                              // 0x13B0 (size: 0x8)
    class UTextWidget* TradeResultWeight;                                             // 0x13B8 (size: 0x8)
    class UTextWidget* TradeResultWeightUnits;                                        // 0x13C0 (size: 0x8)
    class UPlatformSwitcher* TraderButtonSwitcher;                                    // 0x13C8 (size: 0x8)
    class UHintInputController* ButtonHintConfirmTrade;                               // 0x13D0 (size: 0x8)
    class UHintInputController* ButtonHintCancelTrade;                                // 0x13D8 (size: 0x8)
    class UHintInputController* HintBuy;                                              // 0x13E0 (size: 0x8)
    class UHintInputController* HintSell;                                             // 0x13E8 (size: 0x8)
    class UHintInputController* HintReturn;                                           // 0x13F0 (size: 0x8)
...
{
    class UBorder* TextBackgroundBorder;                                              // 0x0418 (size: 0x8)
    FMargin PaddingWithHint;                                                          // 0x0420 (size: 0x10)
    FMargin PaddingWithoutHint;                                                       // 0x0430 (size: 0x10)

}; // Size: 0x440

class UTutorialBase : public UViewBaseExtended
{
    class URichTextBlock* Text;                                                       // 0x02F0 (size: 0x8)
    class UOverlay* TutorialOverlay;                                                  // 0x02F8 (size: 0x8)
    FString HintFont;                                                                 // 0x0300 (size: 0x10)
    float DurationInSeconds;                                                          // 0x03FC (size: 0x4)
...
{
    class UVerticalBox* TitleBox;                                                     // 0x0418 (size: 0x8)
    class UVerticalBox* TitleLineBox;                                                 // 0x0420 (size: 0x8)
    class UVerticalBox* LineWithIconBox;                                              // 0x0428 (size: 0x8)
    class URichTextBlock* TitleTutorText;                                             // 0x0430 (size: 0x8)

}; // Size: 0x438

class UTutorialSplash : public UTutorialBase
{
    class URichTextBlock* TitleTutorText;                                             // 0x0418 (size: 0x8)
...
class UUISettingsWidget : public USettingsPage
{
    ...
    class USettingElementOnOff* Crosshair;                                            // 0x02D0 (size: 0x8)
    class USettingElementOnOff* CrosshairColor;                                       // 0x02D8 (size: 0x8)
    class USettingElementOnOff* QuestNotification;                                    // 0x02E0 (size: 0x8)
    class USettingElementOnOff* Compass;                                              // 0x02E8 (size: 0x8)
    class USettingElementOnOff* AmmoCounter;                                          // 0x02F0 (size: 0x8)
    class USettingElementOnOff* SystemNotification;                                   // 0x02F8 (size: 0x8)
    class USettingElementOnOff* QuickSlot;                                            // 0x0300 (size: 0x8)
    class USettingElementOnOff* InteractDots;                                         // 0x0308 (size: 0x8)
...
class UWorldMap : public UWidgetBase
{
    ...
    class UCanvasPanel* MarkerStorage;                                                // 0x0290 (size: 0x8)
    class UCanvasPanel* ZoneStorage;                                                  // 0x0298 (size: 0x8)
    class UOverlay* MapContainer;                                                     // 0x02A0 (size: 0x8)
    class UWidget* PlayerPosition;                                                    // 0x02A8 (size: 0x8)
    float AddWorldAngle;                                                              // 0x02B0 (size: 0x4)
    FVector2D LandmarkOffset;                                                         // 0x02B8 (size: 0x10)
    FWorldMapOnMapMarkerMarker OnMapMarkerMarker;                                     // 0x02C8 (size: 0x10)
    void OnMapMarkerMarker(bool bIsHovered, class UWorldMapMarker* InHoverMarkerWidget);
    FWorldMapOnMapMarkerClick OnMapMarkerClick;                                       // 0x02D8 (size: 0x10)
    void OnMapMarkerClick(const class UWorldMapMarker* InHoverMarkerWidget);
    TArray<class UWorldMapMarker*> markers;                                           // 0x02E8 (size: 0x10)
    TArray<class UWorldMapMarker*> Landmarks;                                         // 0x02F8 (size: 0x10)
    FUID FollowMarker;                                                                // 0x0308 (size: 0x4)
    class UWorldMapMarker* CurrHoverMarker;                                           // 0x0310 (size: 0x8)
...
{
    class UImage* MiniMarkerMain;                                                     // 0x0330 (size: 0x8)
    class UImage* MiniMarkerSide;                                                     // 0x0338 (size: 0x8)
...
{
    TSubclassOf<class UWorldMapMarker> WorldMapMarkerClass;                           // 0x0100 (size: 0x8)
    TSubclassOf<class UWorldMapMarker> WorldMapRegionMarkerClass;                     // 0x0108 (size: 0x8)
    TSubclassOf<class UWorldMapMarker> WorldMapLocationMarkerClass;                   // 0x0110 (size: 0x8)
    TSubclassOf<class UWorldMapMarker> WorldMapHubMarkerClass;                        // 0x0118 (size: 0x8)
    TSubclassOf<class UMarkerCompassWidget> MarkerCompassWidgetClass;                 // 0x0120 (size: 0x8)
    class UDataTable* MarkerIconsDataTable;                                           // 0x0128 (size: 0x8)
    class UMarkerSettings* MarkerSettingsAsset;                                       // 0x0130 (size: 0x8)
    class AWorldMapScene* WorldMapScene;                                              // 0x0188 (size: 0x8)
    class USRLEAsset* RegionTexture;                                                  // 0x01B0 (size: 0x8)
    TMap<class ETrackGroup, class FUID> TrackedMarkers;                               // 0x01C0 (size: 0x50)
...
class UWorldMapMarker : public UWidgetBase
{
    ...
    TSubclassOf<class UWorldMapMarkerZone> ZoneWidgetClass;                           // 0x02A0 (size: 0x8)
    class UImage* MarkerIcon;                                                         // 0x02A8 (size: 0x8)
    class USizeBox* MarkerSizeBox;                                                    // 0x02B0 (size: 0x8)
    class UButton* ClickZone;                                                         // 0x02B8 (size: 0x8)
    FVector2D MarkerAlignment;                                                        // 0x02C0 (size: 0x10)
    float MarkerSize;                                                                 // 0x02D0 (size: 0x4)
    bool bEnableHoverScale;                                                           // 0x02D4 (size: 0x1)
    float HoverScaleValue;                                                            // 0x02D8 (size: 0x4)
    bool bEnableMarkerClick;                                                          // 0x02DC (size: 0x1)
    class UCanvasPanelSlot* ParentCanvasSlot;                                         // 0x0318 (size: 0x8)
    class UWorldMapMarkerZone* ZoneWidget;                                            // 0x0320 (size: 0x8)
    class UCanvasPanel* ZoneCanvas;                                                   // 0x0328 (size: 0x8)
...
class UWorldMapMarkerZone : public UWidgetBase
{
    class UImage* ZoneMaterial;                                                       // 0x0278 (size: 0x8)
    class USizeBox* SizeBox;                                                          // 0x0280 (size: 0x8)
    FName MaterialScaleFieldName;                                                     // 0x0288 (size: 0x8)
    FName MaterialColorFieldName;                                                     // 0x0290 (size: 0x8)
    class UCanvasPanelSlot* ParentCanvasSlot;                                         // 0x02A0 (size: 0x8)
    class UCanvasPanel* ZoneCanvas;                                                   // 0x02A8 (size: 0x8)
...
{
    class UTextWidget* RegionName;                                                    // 0x0330 (size: 0x8)
