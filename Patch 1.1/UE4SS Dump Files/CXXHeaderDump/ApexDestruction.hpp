...
{
    uint8 bFractureEffectOverride;                                                    // 0x08D0 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x08D8 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x08E8 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x08EC (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x08F0 (size: 0x10)
