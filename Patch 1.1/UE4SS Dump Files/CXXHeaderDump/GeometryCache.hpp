...
{
    class UGeometryCache* GeometryCache;                                              // 0x0598 (size: 0x8)
    bool bRunning;                                                                    // 0x05A0 (size: 0x1)
    bool bLooping;                                                                    // 0x05A1 (size: 0x1)
    bool bDisableAsyncMeshDataFetching;                                               // 0x05A2 (size: 0x1)
    bool bExtrapolateFrames;                                                          // 0x05A3 (size: 0x1)
    float StartTimeOffset;                                                            // 0x05A4 (size: 0x4)
    float PlaybackSpeed;                                                              // 0x05A8 (size: 0x4)
    float MotionVectorScale;                                                          // 0x05AC (size: 0x4)
    int32 NumTracks;                                                                  // 0x05B0 (size: 0x4)
    bool bWaitTillAllTracksReady;                                                     // 0x05C8 (size: 0x1)
    float CurrentAnimTime;                                                            // 0x05CC (size: 0x4)
    float Duration;                                                                   // 0x061C (size: 0x4)
    bool bManualTick;                                                                 // 0x0620 (size: 0x1)
    bool bOverrideWireframeColor;                                                     // 0x0621 (size: 0x1)
    FLinearColor WireframeOverrideColor;                                              // 0x0624 (size: 0x10)
