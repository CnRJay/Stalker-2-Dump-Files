...
{
    class UFieldSystem* FieldSystem;                                                  // 0x0560 (size: 0x8)
    bool bIsWorldField;                                                               // 0x0568 (size: 0x1)
    bool bIsChaosField;                                                               // 0x0569 (size: 0x1)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x0570 (size: 0x10)
    FFieldObjectCommands ConstructionCommands;                                        // 0x0580 (size: 0x30)
    FFieldObjectCommands BufferCommands;                                              // 0x05B0 (size: 0x30)
