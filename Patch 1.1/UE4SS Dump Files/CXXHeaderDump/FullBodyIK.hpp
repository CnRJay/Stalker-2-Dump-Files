...
{
    FRigElementKey Root;                                                              // 0x0040 (size: 0xC)
    TArray<FFBIKEndEffector> Effectors;                                               // 0x0050 (size: 0x10)
    TArray<FFBIKConstraintOption> Constraints;                                        // 0x0060 (size: 0x10)
    FSolverInput SolverProperty;                                                      // 0x0070 (size: 0x24)
    FMotionProcessInput MotionProperty;                                               // 0x0094 (size: 0x2)
    bool bPropagateToChildren;                                                        // 0x0096 (size: 0x1)
    FFBIKDebugOption DebugOption;                                                     // 0x00A0 (size: 0x80)
    FRigUnit_FullbodyIK_WorkData WorkData;                                            // 0x0120 (size: 0x198)
