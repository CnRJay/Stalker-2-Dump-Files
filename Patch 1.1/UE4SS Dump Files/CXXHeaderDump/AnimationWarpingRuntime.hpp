...
struct FAnimNode_FootPlacement : public FAnimNode_SkeletalControlBase
{
    ...
    FFootPlacementPelvisSettings PelvisSettings;                                      // 0x00EC (size: 0x30)
    TArray<FFootPlacemenLegDefinition> LegDefinitions;                                // 0x0120 (size: 0x10)
    FFootPlacementPlantSettings PlantSettings;                                        // 0x0130 (size: 0x34)
    FFootPlacementInterpolationSettings InterpolationSettings;                        // 0x0164 (size: 0x2C)
    FFootPlacementTraceSettings TraceSettings;                                        // 0x0190 (size: 0x18)
    FVector BaseTranslationDelta;                                                     // 0x01A8 (size: 0x18)
    uint8 IsPaused;                                                                   // 0x01C0 (size: 0x1)
...
struct FFootPlacementPelvisSettings
{
    ...
    bool bDisablePelvisOffsetInAir;                                                   // 0x0027 (size: 0x1)
    FName DisablePelvisCurveName;                                                     // 0x0028 (size: 0x8)
