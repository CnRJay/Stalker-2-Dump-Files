...
{
    uint8 bAutoRegisterWithBudgetAllocator;                                           // 0x0FE8 (size: 0x1)
    uint8 bAutoCalculateSignificance;                                                 // 0x0FE8 (size: 0x1)
    uint8 bShouldUseActorRenderedFlag;                                                // 0x0FE8 (size: 0x1)
