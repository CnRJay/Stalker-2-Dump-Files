...
{
    FTextBlockStyle TextStyle;                                                        // 0x0010 (size: 0x3A0)
...
class UBackgroundBlur : public UContentWidget
{
    ...
    FSlateBrush LowQualityFallbackBrush;                                              // 0x01B0 (size: 0xF0)
...
class UBorder : public UContentWidget
{
    ...
    FSlateBrush Background;                                                           // 0x01A0 (size: 0xF0)
    FBorderBackgroundDelegate BackgroundDelegate;                                     // 0x0290 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor BrushColor;                                                          // 0x02A0 (size: 0x10)
    FBorderBrushColorDelegate BrushColorDelegate;                                     // 0x02B0 (size: 0x10)
    FLinearColor GetLinearColor();
    FVector2D DesiredSizeScale;                                                       // 0x02C0 (size: 0x10)
    bool bFlipForRightToLeftFlowDirection;                                            // 0x02D0 (size: 0x1)
    FBorderOnMouseButtonDownEvent OnMouseButtonDownEvent;                             // 0x02D4 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseButtonUpEvent OnMouseButtonUpEvent;                                 // 0x02E4 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseMoveEvent OnMouseMoveEvent;                                         // 0x02F4 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseDoubleClickEvent OnMouseDoubleClickEvent;                           // 0x0304 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
{
    FButtonStyle WidgetStyle;                                                         // 0x0170 (size: 0x470)
    FLinearColor ColorAndOpacity;                                                     // 0x05E0 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x05F0 (size: 0x10)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x0600 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x0601 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x0602 (size: 0x1)
    bool IsFocusable;                                                                 // 0x0603 (size: 0x1)
    FButtonOnClicked OnClicked;                                                       // 0x0608 (size: 0x10)
    void OnButtonClickedEvent();
    FButtonOnPressed OnPressed;                                                       // 0x0618 (size: 0x10)
    void OnButtonPressedEvent();
    FButtonOnReleased OnReleased;                                                     // 0x0628 (size: 0x10)
    void OnButtonReleasedEvent();
    FButtonOnHovered OnHovered;                                                       // 0x0638 (size: 0x10)
    void OnButtonHoverEvent();
    FButtonOnUnhovered OnUnhovered;                                                   // 0x0648 (size: 0x10)
    void OnButtonHoverEvent();
...
class UCheckBox : public UContentWidget
{
    ...
    FCheckBoxStyle WidgetStyle;                                                       // 0x0180 (size: 0xC50)
    TEnumAsByte<EHorizontalAlignment> HorizontalAlignment;                            // 0x0DD0 (size: 0x1)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x0DD1 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x0DD2 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x0DD3 (size: 0x1)
    bool IsFocusable;                                                                 // 0x0DD4 (size: 0x1)
    FCheckBoxOnCheckStateChanged OnCheckStateChanged;                                 // 0x0DD8 (size: 0x10)
...
class UCircularThrobber : public UWidget
{
    ...
    FSlateBrush Image;                                                                // 0x0160 (size: 0xF0)
    bool bEnableRadius;                                                               // 0x0250 (size: 0x1)
...
class UComboBoxKey : public UWidget
{
    ...
    FComboBoxStyle WidgetStyle;                                                       // 0x0170 (size: 0x720)
    FTableRowStyle ItemStyle;                                                         // 0x0890 (size: 0xF50)
    FSlateColor ForegroundColor;                                                      // 0x17E0 (size: 0x14)
    FMargin ContentPadding;                                                           // 0x17F4 (size: 0x10)
    float MaxListHeight;                                                              // 0x1804 (size: 0x4)
    bool bHasDownArrow;                                                               // 0x1808 (size: 0x1)
    bool bEnableGamepadNavigationMode;                                                // 0x1809 (size: 0x1)
    bool bIsFocusable;                                                                // 0x180A (size: 0x1)
    FComboBoxKeyOnGenerateContentWidget OnGenerateContentWidget;                      // 0x180C (size: 0x10)
    class UWidget* GenerateWidgetEvent(FName Item);
    FComboBoxKeyOnGenerateItemWidget OnGenerateItemWidget;                            // 0x181C (size: 0x10)
    class UWidget* GenerateWidgetEvent(FName Item);
    FComboBoxKeyOnSelectionChanged OnSelectionChanged;                                // 0x1830 (size: 0x10)
    void OnSelectionChangedEvent(FName SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxKeyOnOpening OnOpening;                                                  // 0x1840 (size: 0x10)
    void OnOpeningEvent();
...
class UComboBoxString : public UWidget
{
    ...
    FComboBoxStyle WidgetStyle;                                                       // 0x0170 (size: 0x720)
    FTableRowStyle ItemStyle;                                                         // 0x0890 (size: 0xF50)
    FMargin ContentPadding;                                                           // 0x17E0 (size: 0x10)
    float MaxListHeight;                                                              // 0x17F0 (size: 0x4)
    bool HasDownArrow;                                                                // 0x17F4 (size: 0x1)
    bool EnableGamepadNavigationMode;                                                 // 0x17F5 (size: 0x1)
    FSlateFontInfo Font;                                                              // 0x17F8 (size: 0x58)
    FSlateColor ForegroundColor;                                                      // 0x1850 (size: 0x14)
    bool bIsFocusable;                                                                // 0x1864 (size: 0x1)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x1868 (size: 0x10)
    class UWidget* GenerateWidgetForString(FString Item);
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x1878 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x1888 (size: 0x10)
    void OnOpeningEvent();
...
class UEditableText : public UWidget
{
    ...
    FText GetText();
    FEditableTextStyle WidgetStyle;                                                   // 0x01A0 (size: 0x350)
    bool IsReadOnly;                                                                  // 0x04F0 (size: 0x1)
    bool IsPassword;                                                                  // 0x04F1 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x04F4 (size: 0x4)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x04F8 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x04F9 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x04FA (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x04FB (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x04FC (size: 0x1)
    bool AllowContextMenu;                                                            // 0x04FD (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x04FE (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x04FF (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x0500 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0501 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0502 (size: 0x1)
    ETextOverflowPolicy OverflowPolicy;                                               // 0x0503 (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x0504 (size: 0x3)
    FEditableTextOnTextChanged OnTextChanged;                                         // 0x0508 (size: 0x10)
    void OnEditableTextChangedEvent(const FText& Text);
    FEditableTextOnTextCommitted OnTextCommitted;                                     // 0x0518 (size: 0x10)
...
class UEditableTextBox : public UWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0180 (size: 0x1080)
    FText HintText;                                                                   // 0x1200 (size: 0x18)
    FEditableTextBoxHintTextDelegate HintTextDelegate;                                // 0x1218 (size: 0x10)
    FText GetText();
    bool IsReadOnly;                                                                  // 0x1228 (size: 0x1)
    bool IsPassword;                                                                  // 0x1229 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x122C (size: 0x4)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x1230 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x1231 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x1232 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x1233 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x1234 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x1235 (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x1236 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x1237 (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x1238 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x1239 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x123A (size: 0x1)
    ETextOverflowPolicy OverflowPolicy;                                               // 0x123B (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x123C (size: 0x3)
    FEditableTextBoxOnTextChanged OnTextChanged;                                      // 0x1240 (size: 0x10)
    void OnEditableTextBoxChangedEvent(const FText& Text);
    FEditableTextBoxOnTextCommitted OnTextCommitted;                                  // 0x1250 (size: 0x10)
...
{
    FExpandableAreaStyle Style;                                                       // 0x0160 (size: 0x200)
    FSlateBrush BorderBrush;                                                          // 0x0360 (size: 0xF0)
    FSlateColor BorderColor;                                                          // 0x0450 (size: 0x14)
    bool bIsExpanded;                                                                 // 0x0464 (size: 0x1)
    float MaxHeight;                                                                  // 0x0468 (size: 0x4)
    FMargin HeaderPadding;                                                            // 0x046C (size: 0x10)
    FMargin AreaPadding;                                                              // 0x047C (size: 0x10)
    FExpandableAreaOnExpansionChanged OnExpansionChanged;                             // 0x0490 (size: 0x10)
    void OnExpandableAreaExpansionChanged(class UExpandableArea* Area, bool bIsExpanded);
    class UWidget* HeaderContent;                                                     // 0x04A0 (size: 0x8)
    class UWidget* BodyContent;                                                       // 0x04A8 (size: 0x8)
...
{
    FSlateBrush Brush;                                                                // 0x0150 (size: 0xF0)
    FImageBrushDelegate BrushDelegate;                                                // 0x0240 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor ColorAndOpacity;                                                     // 0x0250 (size: 0x10)
    FImageColorAndOpacityDelegate ColorAndOpacityDelegate;                            // 0x0260 (size: 0x10)
    FLinearColor GetLinearColor();
    bool bFlipForRightToLeftFlowDirection;                                            // 0x0270 (size: 0x1)
    FImageOnMouseButtonDownEvent OnMouseButtonDownEvent;                              // 0x0274 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
{
    FButtonStyle WidgetStyle;                                                         // 0x0150 (size: 0x470)
    FTextBlockStyle TextStyle;                                                        // 0x05C0 (size: 0x3A0)
    FInputChord SelectedKey;                                                          // 0x0960 (size: 0x20)
    FMargin Margin;                                                                   // 0x0980 (size: 0x10)
    FText KeySelectionText;                                                           // 0x0990 (size: 0x18)
    FText NoKeySpecifiedText;                                                         // 0x09A8 (size: 0x18)
    bool bAllowModifierKeys;                                                          // 0x09C0 (size: 0x1)
    bool bAllowGamepadKeys;                                                           // 0x09C1 (size: 0x1)
    TArray<FKey> EscapeKeys;                                                          // 0x09C8 (size: 0x10)
    FInputKeySelectorOnKeySelected OnKeySelected;                                     // 0x09D8 (size: 0x10)
    void OnKeySelected(FInputChord SelectedKey);
    FInputKeySelectorOnIsSelectingKeyChanged OnIsSelectingKeyChanged;                 // 0x09E8 (size: 0x10)
...
{
    FTableViewStyle WidgetStyle;                                                      // 0x0340 (size: 0x100)
    FScrollBarStyle ScrollBarStyle;                                                   // 0x0440 (size: 0x890)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0CD0 (size: 0x1)
    TEnumAsByte<ESelectionMode::Type> SelectionMode;                                  // 0x0CD1 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x0CD2 (size: 0x1)
    bool bClearSelectionOnClick;                                                      // 0x0CD3 (size: 0x1)
    bool bIsFocusable;                                                                // 0x0CD4 (size: 0x1)
    float EntrySpacing;                                                               // 0x0CD8 (size: 0x4)
    bool bReturnFocusToSelection;                                                     // 0x0CDC (size: 0x1)
    TArray<class UObject*> ListItems;                                                 // 0x0CE0 (size: 0x10)
    FListViewBP_OnEntryInitialized BP_OnEntryInitialized;                             // 0x0D00 (size: 0x10)
    void OnListEntryInitializedDynamic(class UObject* Item, class UUserWidget* Widget);
    FListViewBP_OnItemClicked BP_OnItemClicked;                                       // 0x0D10 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* Item);
    FListViewBP_OnItemDoubleClicked BP_OnItemDoubleClicked;                           // 0x0D20 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* Item);
    FListViewBP_OnItemIsHoveredChanged BP_OnItemIsHoveredChanged;                     // 0x0D30 (size: 0x10)
    void OnItemIsHoveredChangedDynamic(class UObject* Item, bool bIsHovered);
    FListViewBP_OnItemSelectionChanged BP_OnItemSelectionChanged;                     // 0x0D40 (size: 0x10)
    void OnListItemSelectionChangedDynamic(class UObject* Item, bool bIsSelected);
    FListViewBP_OnItemScrolledIntoView BP_OnItemScrolledIntoView;                     // 0x0D50 (size: 0x10)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    FText GetText();
    FTextBlockStyle WidgetStyle;                                                      // 0x01B0 (size: 0x3A0)
    bool bIsReadOnly;                                                                 // 0x0550 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x0551 (size: 0x1)
    bool ClearTextSelectionOnFocusLoss;                                               // 0x0552 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x0553 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0554 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0555 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0556 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0557 (size: 0x1)
    FMultiLineEditableTextOnTextChanged OnTextChanged;                                // 0x0558 (size: 0x10)
    void OnMultiLineEditableTextChangedEvent(const FText& Text);
    FMultiLineEditableTextOnTextCommitted OnTextCommitted;                            // 0x0568 (size: 0x10)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x01B0 (size: 0x1080)
    bool bIsReadOnly;                                                                 // 0x1230 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x1231 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x1232 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x1233 (size: 0x1)
    FMultiLineEditableTextBoxOnTextChanged OnTextChanged;                             // 0x1238 (size: 0x10)
    void OnMultiLineEditableTextBoxChangedEvent(const FText& Text);
    FMultiLineEditableTextBoxOnTextCommitted OnTextCommitted;                         // 0x1248 (size: 0x10)
...
{
    FProgressBarStyle WidgetStyle;                                                    // 0x0150 (size: 0x2F0)
    float Percent;                                                                    // 0x0440 (size: 0x4)
    TEnumAsByte<EProgressBarFillType::Type> BarFillType;                              // 0x0444 (size: 0x1)
    TEnumAsByte<EProgressBarFillStyle::Type> BarFillStyle;                            // 0x0445 (size: 0x1)
    bool bIsMarquee;                                                                  // 0x0446 (size: 0x1)
    FVector2D BorderPadding;                                                          // 0x0448 (size: 0x10)
    FProgressBarPercentDelegate PercentDelegate;                                      // 0x0458 (size: 0x10)
    float GetFloat();
    FLinearColor FillColorAndOpacity;                                                 // 0x0468 (size: 0x10)
    FProgressBarFillColorAndOpacityDelegate FillColorAndOpacityDelegate;              // 0x0478 (size: 0x10)
    FLinearColor GetLinearColor();
...
class URichTextBlock : public UTextLayoutWidget
{
    ...
    FTextBlockStyle DefaultTextStyleOverride;                                         // 0x01B0 (size: 0x3A0)
    float MinDesiredWidth;                                                            // 0x0550 (size: 0x4)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x0554 (size: 0x1)
    ETextOverflowPolicy TextOverflowPolicy;                                           // 0x0555 (size: 0x1)
    FTextBlockStyle DefaultTextStyle;                                                 // 0x0560 (size: 0x3A0)
    TArray<class URichTextBlockDecorator*> InstanceDecorators;                        // 0x0900 (size: 0x10)
...
{
    FScrollBarStyle WidgetStyle;                                                      // 0x0150 (size: 0x890)
    bool bAlwaysShowScrollbar;                                                        // 0x09E0 (size: 0x1)
    bool bAlwaysShowScrollbarTrack;                                                   // 0x09E1 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x09E2 (size: 0x1)
    FVector2D Thickness;                                                              // 0x09E8 (size: 0x10)
    FMargin Padding;                                                                  // 0x09F8 (size: 0x10)
...
{
    FScrollBoxStyle WidgetStyle;                                                      // 0x0170 (size: 0x3D0)
    FScrollBarStyle WidgetBarStyle;                                                   // 0x0540 (size: 0x890)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0DD0 (size: 0x1)
    ESlateVisibility ScrollBarVisibility;                                             // 0x0DD1 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x0DD2 (size: 0x1)
    FVector2D ScrollbarThickness;                                                     // 0x0DD8 (size: 0x10)
    FMargin ScrollbarPadding;                                                         // 0x0DE8 (size: 0x10)
    bool AlwaysShowScrollbar;                                                         // 0x0DF8 (size: 0x1)
    bool AlwaysShowScrollbarTrack;                                                    // 0x0DF9 (size: 0x1)
    bool AllowOverscroll;                                                             // 0x0DFA (size: 0x1)
    bool BackPadScrolling;                                                            // 0x0DFB (size: 0x1)
    bool FrontPadScrolling;                                                           // 0x0DFC (size: 0x1)
    bool bAnimateWheelScrolling;                                                      // 0x0DFD (size: 0x1)
    EDescendantScrollDestination NavigationDestination;                               // 0x0DFE (size: 0x1)
    float NavigationScrollPadding;                                                    // 0x0E00 (size: 0x4)
    EScrollWhenFocusChanges ScrollWhenFocusChanges;                                   // 0x0E04 (size: 0x1)
    bool bAllowRightClickDragScrolling;                                               // 0x0E05 (size: 0x1)
    float WheelScrollMultiplier;                                                      // 0x0E08 (size: 0x4)
    FScrollBoxOnUserScrolled OnUserScrolled;                                          // 0x0E10 (size: 0x10)
...
class USlider : public UWidget
{
    ...
    FSliderStyle WidgetStyle;                                                         // 0x0170 (size: 0x5C0)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0730 (size: 0x1)
    FLinearColor SliderBarColor;                                                      // 0x0734 (size: 0x10)
    FLinearColor SliderHandleColor;                                                   // 0x0744 (size: 0x10)
    bool IndentHandle;                                                                // 0x0754 (size: 0x1)
    bool Locked;                                                                      // 0x0755 (size: 0x1)
    bool MouseUsesStep;                                                               // 0x0756 (size: 0x1)
    bool RequiresControllerLock;                                                      // 0x0757 (size: 0x1)
    float StepSize;                                                                   // 0x0758 (size: 0x4)
    bool IsFocusable;                                                                 // 0x075C (size: 0x1)
    FSliderOnMouseCaptureBegin OnMouseCaptureBegin;                                   // 0x0760 (size: 0x10)
    void OnMouseCaptureBeginEvent();
    FSliderOnMouseCaptureEnd OnMouseCaptureEnd;                                       // 0x0770 (size: 0x10)
    void OnMouseCaptureEndEvent();
    FSliderOnControllerCaptureBegin OnControllerCaptureBegin;                         // 0x0780 (size: 0x10)
    void OnControllerCaptureBeginEvent();
    FSliderOnControllerCaptureEnd OnControllerCaptureEnd;                             // 0x0790 (size: 0x10)
    void OnControllerCaptureEndEvent();
    FSliderOnValueChanged OnValueChanged;                                             // 0x07A0 (size: 0x10)
...
class USpinBox : public UWidget
{
    ...
    float GetFloat();
    FSpinBoxStyle WidgetStyle;                                                        // 0x0170 (size: 0x6E0)
    int32 MinFractionalDigits;                                                        // 0x0850 (size: 0x4)
    int32 MaxFractionalDigits;                                                        // 0x0854 (size: 0x4)
    bool bAlwaysUsesDeltaSnap;                                                        // 0x0858 (size: 0x1)
    bool bEnableSlider;                                                               // 0x0859 (size: 0x1)
    float Delta;                                                                      // 0x085C (size: 0x4)
    float SliderExponent;                                                             // 0x0860 (size: 0x4)
    FSlateFontInfo Font;                                                              // 0x0868 (size: 0x58)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x08C0 (size: 0x1)
    float MinDesiredWidth;                                                            // 0x08C4 (size: 0x4)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x08C8 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x08C9 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x08CA (size: 0x1)
    FSlateColor ForegroundColor;                                                      // 0x08CC (size: 0x14)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x08E0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x08F0 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x0900 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x0910 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x0920 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x0920 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x0920 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x0920 (size: 0x1)
    float MinValue;                                                                   // 0x0924 (size: 0x4)
    float MaxValue;                                                                   // 0x0928 (size: 0x4)
    float MinSliderValue;                                                             // 0x092C (size: 0x4)
    float MaxSliderValue;                                                             // 0x0930 (size: 0x4)
...
class UTextBlock : public UTextLayoutWidget
{
    ...
    FSlateBrush StrikeBrush;                                                          // 0x0220 (size: 0xF0)
    FVector2D ShadowOffset;                                                           // 0x0310 (size: 0x10)
    FLinearColor ShadowColorAndOpacity;                                               // 0x0320 (size: 0x10)
    FTextBlockShadowColorAndOpacityDelegate ShadowColorAndOpacityDelegate;            // 0x0330 (size: 0x10)
    FLinearColor GetLinearColor();
    float MinDesiredWidth;                                                            // 0x0340 (size: 0x4)
    bool bWrapWithInvalidationPanel;                                                  // 0x0344 (size: 0x1)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x0345 (size: 0x1)
    ETextOverflowPolicy TextOverflowPolicy;                                           // 0x0346 (size: 0x1)
    bool bSimpleTextMode;                                                             // 0x0347 (size: 0x1)
...
{
    float EntryHeight;                                                                // 0x0D60 (size: 0x4)
    float EntryWidth;                                                                 // 0x0D64 (size: 0x4)
    EListItemAlignment TileAlignment;                                                 // 0x0D68 (size: 0x1)
    bool bWrapHorizontalNavigation;                                                   // 0x0D69 (size: 0x1)
...
{
    FTreeViewBP_OnGetItemChildren BP_OnGetItemChildren;                               // 0x0D70 (size: 0x10)
    void OnGetItemChildrenDynamic(class UObject* Item, TArray<class UObject*>& Children);
    FTreeViewBP_OnItemExpansionChanged BP_OnItemExpansionChanged;                     // 0x0D80 (size: 0x10)
...
class UUserWidget : public UWidget
{
    ...
    void ListenForInputAction(FName ActionName, TEnumAsByte<EInputEvent> EventType, bool bConsume, FListenForInputActionCallback Callback, bool bIgnorePause);
...
class UWidgetBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
    ...
    TArray<FFieldNotificationId> FieldNotifyNames;                                    // 0x0378 (size: 0x10)
    uint8 bClassRequiresNativeTick;                                                   // 0x038C (size: 0x1)
    TArray<FDelegateRuntimeBinding> Bindings;                                         // 0x0390 (size: 0x10)
    TArray<class UWidgetAnimation*> Animations;                                       // 0x03A0 (size: 0x10)
    TArray<FName> NamedSlots;                                                         // 0x03B0 (size: 0x10)
    TArray<FName> AvailableNamedSlots;                                                // 0x03C0 (size: 0x10)
    TArray<FName> InstanceNamedSlots;                                                 // 0x03D0 (size: 0x10)
...
{
    EWidgetSpace space;                                                               // 0x0598 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x0599 (size: 0x1)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x05A0 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x05A8 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x05B0 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x05B1 (size: 0x1)
    float RedrawTime;                                                                 // 0x05B4 (size: 0x4)
    FIntPoint CurrentDrawSize;                                                        // 0x05C0 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x05C8 (size: 0x1)
    FVector2D Pivot;                                                                  // 0x05D0 (size: 0x10)
    bool bReceiveHardwareInput;                                                       // 0x05E0 (size: 0x1)
    bool bWindowFocusable;                                                            // 0x05E1 (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x05E2 (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x05E3 (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x05E8 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x05F0 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x0600 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x0610 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x0614 (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x0615 (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x0616 (size: 0x1)
    class UBodySetup* BodySetup;                                                      // 0x0618 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x0620 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x0628 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x0630 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x0638 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x0640 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x0648 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0650 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0658 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x0660 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x0661 (size: 0x1)
    FName SharedLayerName;                                                            // 0x0664 (size: 0x8)
    int32 LayerZOrder;                                                                // 0x066C (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x0670 (size: 0x1)
    float CylinderArcAngle;                                                           // 0x0674 (size: 0x4)
    ETickMode TickMode;                                                               // 0x0678 (size: 0x1)
    class UUserWidget* Widget;                                                        // 0x06A8 (size: 0x8)
