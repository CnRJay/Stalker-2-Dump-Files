...
{
    class AChaosSolverActor* ChaosSolverActor;                                        // 0x05A0 (size: 0x8)
    class UGeometryCollection* RestCollection;                                        // 0x0690 (size: 0x8)
    TArray<class AFieldSystemActor*> InitializationFields;                            // 0x0698 (size: 0x10)
    bool Simulating;                                                                  // 0x06A8 (size: 0x1)
    EObjectStateTypeEnum ObjectType;                                                  // 0x06B0 (size: 0x1)
    bool bForceMotionBlur;                                                            // 0x06B1 (size: 0x1)
    bool EnableClustering;                                                            // 0x06B2 (size: 0x1)
    int32 ClusterGroupIndex;                                                          // 0x06B4 (size: 0x4)
    int32 MaxClusterLevel;                                                            // 0x06B8 (size: 0x4)
    TArray<float> DamageThreshold;                                                    // 0x06C0 (size: 0x10)
    bool bUseSizeSpecificDamageThreshold;                                             // 0x06D0 (size: 0x1)
    FGeometryCollectionDamagePropagationData DamagePropagationData;                   // 0x06D4 (size: 0xC)
    bool bAllowRemovalOnSleep;                                                        // 0x06E0 (size: 0x1)
    bool bAllowRemovalOnBreak;                                                        // 0x06E1 (size: 0x1)
    EClusterConnectionTypeEnum ClusterConnectionType;                                 // 0x06E2 (size: 0x1)
    int32 CollisionGroup;                                                             // 0x06E4 (size: 0x4)
    float CollisionSampleFraction;                                                    // 0x06E8 (size: 0x4)
    float LinearEtherDrag;                                                            // 0x06EC (size: 0x4)
    float AngularEtherDrag;                                                           // 0x06F0 (size: 0x4)
    class UChaosPhysicalMaterial* PhysicalMaterial;                                   // 0x06F8 (size: 0x8)
    EInitialVelocityTypeEnum InitialVelocityType;                                     // 0x0700 (size: 0x1)
    FVector InitialLinearVelocity;                                                    // 0x0708 (size: 0x18)
    FVector InitialAngularVelocity;                                                   // 0x0720 (size: 0x18)
    class UPhysicalMaterial* PhysicalMaterialOverride;                                // 0x0738 (size: 0x8)
    FGeomComponentCacheParameters CacheParameters;                                    // 0x0740 (size: 0x50)
    TArray<FTransform> RestTransforms;                                                // 0x0790 (size: 0x10)
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsStateChange NotifyGeometryCollectionPhysicsStateChange; // 0x07A0 (size: 0x10)
    void NotifyGeometryCollectionPhysicsStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsLoadingStateChange NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x07B0 (size: 0x10)
    void NotifyGeometryCollectionPhysicsLoadingStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentOnChaosBreakEvent OnChaosBreakEvent;                  // 0x07D8 (size: 0x10)
    void OnChaosBreakEvent(const FChaosBreakEvent& BreakEvent);
    FGeometryCollectionComponentOnChaosRemovalEvent OnChaosRemovalEvent;              // 0x07E8 (size: 0x10)
    void OnChaosRemovalEvent(const FChaosRemovalEvent& RemovalEvent);
    FGeometryCollectionComponentOnChaosCrumblingEvent OnChaosCrumblingEvent;          // 0x07F8 (size: 0x10)
    void OnChaosCrumblingEvent(const FChaosCrumblingEvent& CrumbleEvent);
    float DesiredCacheTime;                                                           // 0x0808 (size: 0x4)
    bool CachePlayback;                                                               // 0x080C (size: 0x1)
    FGeometryCollectionComponentOnChaosPhysicsCollision OnChaosPhysicsCollision;      // 0x0810 (size: 0x10)
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    bool bNotifyBreaks;                                                               // 0x0820 (size: 0x1)
    bool bNotifyCollisions;                                                           // 0x0821 (size: 0x1)
    bool bNotifyTrailing;                                                             // 0x0822 (size: 0x1)
    bool bNotifyRemovals;                                                             // 0x0823 (size: 0x1)
    bool bNotifyCrumblings;                                                           // 0x0824 (size: 0x1)
    bool bCrumblingEventIncludesChildren;                                             // 0x0825 (size: 0x1)
    bool bStoreVelocities;                                                            // 0x0826 (size: 0x1)
    bool bShowBoneColors;                                                             // 0x0827 (size: 0x1)
    class AGeometryCollectionISMPoolActor* ISMPool;                                   // 0x0828 (size: 0x8)
    bool bEnableReplication;                                                          // 0x0834 (size: 0x1)
    bool bEnableAbandonAfterLevel;                                                    // 0x0835 (size: 0x1)
    int32 ReplicationAbandonClusterLevel;                                             // 0x0838 (size: 0x4)
    int32 ReplicationAbandonAfterLevel;                                               // 0x083C (size: 0x4)
    FGeometryCollectionRepData RepData;                                               // 0x0840 (size: 0x28)
    class UBodySetup* DummyBodySetup;                                                 // 0x0AF0 (size: 0x8)
    TArray<class UInstancedStaticMeshComponent*> EmbeddedGeometryComponents;          // 0x0B00 (size: 0x10)
