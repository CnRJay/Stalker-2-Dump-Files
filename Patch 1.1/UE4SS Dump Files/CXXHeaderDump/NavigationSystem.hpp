...
{
    uint8 bDrawNavBoundsIntersection;                                                 // 0x04E0 (size: 0x1)
    uint8 bDrawNavBounds;                                                             // 0x04E0 (size: 0x1)
    uint8 bDrawDirtyTilesBB;                                                          // 0x04E0 (size: 0x1)
    uint8 bDrawTriangleEdges;                                                         // 0x04E0 (size: 0x1)
    uint8 bDrawPolyEdges;                                                             // 0x04E0 (size: 0x1)
    uint8 bDrawFilledPolys;                                                           // 0x04E0 (size: 0x1)
    uint8 bDrawNavMeshEdges;                                                          // 0x04E0 (size: 0x1)
    uint8 bDrawTileBounds;                                                            // 0x04E0 (size: 0x1)
    uint8 bDrawPathCollidingGeometry;                                                 // 0x04E1 (size: 0x1)
    uint8 bDrawTileLabels;                                                            // 0x04E1 (size: 0x1)
    uint8 bDrawPolygonLabels;                                                         // 0x04E1 (size: 0x1)
    uint8 bDrawDefaultPolygonCost;                                                    // 0x04E1 (size: 0x1)
    uint8 bDrawPolygonFlags;                                                          // 0x04E1 (size: 0x1)
    uint8 bDrawLabelsOnPathNodes;                                                     // 0x04E1 (size: 0x1)
    uint8 bDrawNavLinks;                                                              // 0x04E1 (size: 0x1)
    uint8 bDrawFailedNavLinks;                                                        // 0x04E1 (size: 0x1)
    uint8 bDrawClusters;                                                              // 0x04E2 (size: 0x1)
    uint8 bDrawOctree;                                                                // 0x04E2 (size: 0x1)
    uint8 bDrawOctreeDetails;                                                         // 0x04E2 (size: 0x1)
    uint8 bDrawMarkedForbiddenPolys;                                                  // 0x04E2 (size: 0x1)
    uint8 bDistinctlyDrawTilesBeingBuilt;                                             // 0x04E2 (size: 0x1)
    float DrawOffset;                                                                 // 0x04E4 (size: 0x4)
    FRecastNavMeshTileGenerationDebug TileGenerationDebug;                            // 0x04E8 (size: 0x14)
    uint8 bFixedTilePoolSize;                                                         // 0x04FC (size: 0x1)
    int32 TilePoolSize;                                                               // 0x0500 (size: 0x4)
    float TileSizeUU;                                                                 // 0x0504 (size: 0x4)
    float CellSize;                                                                   // 0x0508 (size: 0x4)
    float CellHeight;                                                                 // 0x050C (size: 0x4)
    float AgentRadius;                                                                // 0x0510 (size: 0x4)
    float AgentHeight;                                                                // 0x0514 (size: 0x4)
    float AgentMaxSlope;                                                              // 0x0518 (size: 0x4)
    float AgentMaxStepHeight;                                                         // 0x051C (size: 0x4)
    float MinRegionArea;                                                              // 0x0520 (size: 0x4)
    float MergeRegionSize;                                                            // 0x0524 (size: 0x4)
    float MaxSimplificationError;                                                     // 0x0528 (size: 0x4)
    int32 MaxSimultaneousTileGenerationJobsCount;                                     // 0x052C (size: 0x4)
    int32 MaxAsyncBuildTasksEditor;                                                   // 0x0530 (size: 0x4)
    int32 MaxAsyncBuildTasksGameThread;                                               // 0x0534 (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x0538 (size: 0x4)
    int32 PolyRefTileBits;                                                            // 0x053C (size: 0x4)
    int32 PolyRefNavPolyBits;                                                         // 0x0540 (size: 0x4)
    int32 PolyRefSaltBits;                                                            // 0x0544 (size: 0x4)
    ...
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x056C (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x056D (size: 0x1)
    ...
    uint8 bGenerateDetailedMesh;                                                      // 0x0578 (size: 0x1)
    ...
    uint8 bDoFullyAsyncNavDataGathering;                                              // 0x0579 (size: 0x1)
