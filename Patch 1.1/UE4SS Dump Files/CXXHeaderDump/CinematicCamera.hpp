...
{
    float CranePitch;                                                                 // 0x0298 (size: 0x4)
    float CraneYaw;                                                                   // 0x029C (size: 0x4)
    float CraneArmLength;                                                             // 0x02A0 (size: 0x4)
    bool bLockMountPitch;                                                             // 0x02A4 (size: 0x1)
    bool bLockMountYaw;                                                               // 0x02A5 (size: 0x1)
    class USceneComponent* TransformComponent;                                        // 0x02A8 (size: 0x8)
    class USceneComponent* CraneYawControl;                                           // 0x02B0 (size: 0x8)
    class USceneComponent* CranePitchControl;                                         // 0x02B8 (size: 0x8)
    class USceneComponent* CraneCameraMount;                                          // 0x02C0 (size: 0x8)

}; // Size: 0x2C8

class ACameraRig_Rail : public AActor
{
    float CurrentPositionOnRail;                                                      // 0x0298 (size: 0x4)
    bool bLockOrientationToRail;                                                      // 0x029C (size: 0x1)
    class USceneComponent* TransformComponent;                                        // 0x02A0 (size: 0x8)
    class USplineComponent* RailSplineComponent;                                      // 0x02A8 (size: 0x8)
    class USceneComponent* RailCameraMount;                                           // 0x02B0 (size: 0x8)
...
{
    FCameraLookatTrackingSettings LookatTrackingSettings;                             // 0x09E0 (size: 0x70)
...
{
    FCameraFilmbackSettings FilmbackSettings;                                         // 0x0A70 (size: 0xC)
    FCameraFilmbackSettings Filmback;                                                 // 0x0A7C (size: 0xC)
    FCameraLensSettings LensSettings;                                                 // 0x0A88 (size: 0x1C)
    FCameraFocusSettings FocusSettings;                                               // 0x0AA8 (size: 0x68)
    FPlateCropSettings CropSettings;                                                  // 0x0B10 (size: 0x4)
    float CurrentFocalLength;                                                         // 0x0B14 (size: 0x4)
    float CurrentAperture;                                                            // 0x0B18 (size: 0x4)
    float CurrentFocusDistance;                                                       // 0x0B1C (size: 0x4)
    uint8 bOverride_CustomNearClippingPlane;                                          // 0x0B20 (size: 0x1)
    float CustomNearClippingPlane;                                                    // 0x0B24 (size: 0x4)
    TArray<FNamedFilmbackPreset> FilmbackPresets;                                     // 0x0B30 (size: 0x10)
    TArray<FNamedLensPreset> LensPresets;                                             // 0x0B40 (size: 0x10)
    FString DefaultFilmbackPresetName;                                                // 0x0B50 (size: 0x10)
    FString DefaultFilmbackPreset;                                                    // 0x0B60 (size: 0x10)
    FString DefaultLensPresetName;                                                    // 0x0B70 (size: 0x10)
    float DefaultLensFocalLength;                                                     // 0x0B80 (size: 0x4)
    float DefaultLensFStop;                                                           // 0x0B84 (size: 0x4)
