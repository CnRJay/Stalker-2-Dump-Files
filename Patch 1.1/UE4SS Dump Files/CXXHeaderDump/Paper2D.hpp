...
{
    class UPaperFlipbookComponent* Sprite;                                            // 0x0628 (size: 0x8)

}; // Size: 0x630

class APaperFlipbookActor : public AActor
{
    class UPaperFlipbookComponent* RenderComponent;                                   // 0x0298 (size: 0x8)

}; // Size: 0x2A0

class APaperGroupedSpriteActor : public AActor
{
    class UPaperGroupedSpriteComponent* RenderComponent;                              // 0x0298 (size: 0x8)

}; // Size: 0x2A0

class APaperSpriteActor : public AActor
{
    class UPaperSpriteComponent* RenderComponent;                                     // 0x0298 (size: 0x8)

}; // Size: 0x2A0

class APaperTerrainActor : public AActor
{
    class USceneComponent* DummyRoot;                                                 // 0x0298 (size: 0x8)
    class UPaperTerrainSplineComponent* SplineComponent;                              // 0x02A0 (size: 0x8)
    class UPaperTerrainComponent* RenderComponent;                                    // 0x02A8 (size: 0x8)

}; // Size: 0x2B0

class APaperTileMapActor : public AActor
{
    class UPaperTileMapComponent* RenderComponent;                                    // 0x0298 (size: 0x8)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x0598 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x05A0 (size: 0x8)
    float PlayRate;                                                                   // 0x05A8 (size: 0x4)
    uint8 bLooping;                                                                   // 0x05AC (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x05AC (size: 0x1)
    uint8 bPlaying;                                                                   // 0x05AC (size: 0x1)
    float AccumulatedTime;                                                            // 0x05B0 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x05B4 (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x05B8 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x05C8 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x05D0 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x0598 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x05A8 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x0598 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x05A0 (size: 0x8)
    FLinearColor SpriteColor;                                                         // 0x05A8 (size: 0x10)
...
{
    class UPaperTerrainMaterial* TerrainMaterial;                                     // 0x0560 (size: 0x8)
    bool bClosedSpline;                                                               // 0x0568 (size: 0x1)
    bool bFilledSpline;                                                               // 0x0569 (size: 0x1)
    class UPaperTerrainSplineComponent* AssociatedSpline;                             // 0x0570 (size: 0x8)
    int32 RandomSeed;                                                                 // 0x0578 (size: 0x4)
    float SegmentOverlapAmount;                                                       // 0x057C (size: 0x4)
    FLinearColor TerrainColor;                                                        // 0x0580 (size: 0x10)
    int32 ReparamStepsPerSegment;                                                     // 0x0590 (size: 0x4)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x0594 (size: 0x1)
    float CollisionThickness;                                                         // 0x0598 (size: 0x4)
...
{
    int32 MapWidth;                                                                   // 0x0598 (size: 0x4)
    int32 MapHeight;                                                                  // 0x059C (size: 0x4)
    int32 TileWidth;                                                                  // 0x05A0 (size: 0x4)
    int32 TileHeight;                                                                 // 0x05A4 (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x05A8 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x05B0 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x05B8 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x05C8 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x05D8 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x05DC (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x05E0 (size: 0x8)
