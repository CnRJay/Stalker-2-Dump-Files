...
ADoorView::ADoorView(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->FirstLeafAkComponent = CreateDefaultSubobject<UAkComponent>(TEXT("AkFirstLeaf"));
    this->SecondLeafAkComponent = CreateDefaultSubobject<UAkComponent>(TEXT("AkSecondLeaf"));
    this->FirstLeafAkComponent->SetupAttachment(FirstLeafMeshComponent);
    this->SecondLeafAkComponent->SetupAttachment(SecondLeafMeshComponent);
