...
void ALandscapeProxy::EditorUndoApplySplineGSC(ULandscapeLayerInfoObject* PaintLayer, USplineComponent* InSplineComponent) {
}

void ALandscapeProxy::EditorSetLandscapeMaterial(UMaterialInterface* NewLandscapeMaterial) {
}

void ALandscapeProxy::EditorApplySplineGSC(USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float HeightOffset, int32 NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName) {
}
