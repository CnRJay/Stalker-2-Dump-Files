...
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=LODSyncComponent -FallbackName=LODSyncComponent
//CROSS-MODULE INCLUDE V2: -ModuleName=MotionWarping -ObjectName=MotionWarpingComponent -FallbackName=MotionWarpingComponent
//CROSS-MODULE INCLUDE V2: -ModuleName=PhysicsControl -ObjectName=PhysicsControlComponent -FallbackName=PhysicsControlComponent
