...
class UMRMeshComponent : public UPrimitiveComponent
{
    ...
    class UMaterialInterface* WireframeMaterial;                                      // 0x0570 (size: 0x8)
    bool bCreateMeshProxySections;                                                    // 0x0578 (size: 0x1)
    bool bUpdateNavMeshOnMeshUpdate;                                                  // 0x0579 (size: 0x1)
    bool bNeverCreateCollisionMesh;                                                   // 0x057B (size: 0x1)
    TArray<class UMRMeshBodyHolder*> BodyHolders;                                     // 0x05C0 (size: 0x10)
