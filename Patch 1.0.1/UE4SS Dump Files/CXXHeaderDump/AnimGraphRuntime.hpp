...
struct FAnimLegIKDefinition
{
    ...
    bool bEnabled;                                                                    // 0x002C (size: 0x1)
    float Alpha;                                                                      // 0x0030 (size: 0x4)

}; // Size: 0x34

struct FAnimNode_AdvancedIK_GSC : public FAnimNode_SkeletalControlBase
{
    FAdvancedIKMediator IKParam;                                                      // 0x00C8 (size: 0x18)
    float StartStretchRatio;                                                          // 0x00F0 (size: 0x4)
    float MaxStretchScale;                                                            // 0x00F4 (size: 0x4)
    FAxis TwistAxis;                                                                  // 0x00F8 (size: 0x20)
    uint8 bAllowStretching;                                                           // 0x0118 (size: 0x1)
    uint8 bAllowTwist;                                                                // 0x0118 (size: 0x1)
...
struct FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
    ...
    class UCurveFloat* InterpSpeedForDifferentAngles;                                 // 0x0190 (size: 0x8)
...
struct FAnimNode_BlendListByPointer_GSC : public FAnimNode_BlendListBase
{
}; // Size: 0x48
...
struct FAnimNode_CameraCopyBone_GSC : public FAnimNode_SkeletalControlBase
{
    FBoneReference SourceBone;                                                        // 0x00C8 (size: 0x10)
    FBoneReference TargetBone;                                                        // 0x00D8 (size: 0x10)
    FRotator SocketRotation;                                                          // 0x00E8 (size: 0x18)
    FVector BoneShift;                                                                // 0x0100 (size: 0x18)
    FRotator BoneRotate;                                                              // 0x0118 (size: 0x18)
    bool bCopyTranslation;                                                            // 0x0130 (size: 0x1)
    bool bCopyRotation;                                                               // 0x0131 (size: 0x1)
    bool bCopyScale;                                                                  // 0x0132 (size: 0x1)
    TEnumAsByte<EBoneControlSpace> ControlSpace;                                      // 0x0133 (size: 0x1)
...
struct FAnimNode_CopyAnotherSkeletonBone_GSC : public FAnimNode_SkeletalControlBase
{
    FName SourceBone;                                                                 // 0x00C8 (size: 0x8)
    FBoneReference TargetBone;                                                        // 0x00D0 (size: 0x10)
    bool bCopyTranslation;                                                            // 0x00E0 (size: 0x1)
    bool bCopyRotation;                                                               // 0x00E1 (size: 0x1)
    bool bCopyScale;                                                                  // 0x00E2 (size: 0x1)
    TEnumAsByte<EBoneControlSpace> ControlSpace;                                      // 0x00E3 (size: 0x1)
    class USkeletalMeshComponent* AnotherSkeletalMeshComponent;                       // 0x00E8 (size: 0x8)
...
struct FAnimNode_CurveBlend_GSC : public FAnimNode_Base
{
    FPoseLink SourcePose;                                                             // 0x0010 (size: 0x10)
    FPoseLink A;                                                                      // 0x0020 (size: 0x10)
    FPoseLink B;                                                                      // 0x0030 (size: 0x10)
    TArray<FName> CurveArray;                                                         // 0x0040 (size: 0x10)
    EAnimAlphaInputType AlphaInputType;                                               // 0x0050 (size: 0x1)
    uint8 bAlphaBoolEnabled;                                                          // 0x0051 (size: 0x1)
    uint8 bResetChildOnActivation;                                                    // 0x0051 (size: 0x1)
    float Alpha;                                                                      // 0x0054 (size: 0x4)
    FInputScaleBias AlphaScaleBias;                                                   // 0x0058 (size: 0x8)
    FInputAlphaBoolBlend AlphaBoolBlend;                                              // 0x0060 (size: 0x48)
    FName AlphaCurveName;                                                             // 0x00A8 (size: 0x8)
    FInputScaleBiasClamp AlphaScaleBiasClamp;                                         // 0x00B0 (size: 0x30)
...
struct FAnimNode_DisableRootMotionGSC : public FAnimNode_Base
{
...
struct FAnimNode_SequenceEvaluator_Standalone : public FAnimNode_SequenceEvaluatorBase
{
    ...
    bool bNormilizedExplicitTime;                                                     // 0x0064 (size: 0x1)
...
struct FAnimNode_SmoothCopyBone_GSC : public FAnimNode_SkeletalControlBase
{
    FBoneReference SourceBone;                                                        // 0x00C8 (size: 0x10)
    FBoneReference TargetBone;                                                        // 0x00D8 (size: 0x10)
    FRotator WeaponTotalRotation;                                                     // 0x00E8 (size: 0x18)
    FVector WeaponTotalShift;                                                         // 0x0100 (size: 0x18)
    FVector WeaponSocketShift;                                                        // 0x0118 (size: 0x18)
    class USkeletalMeshComponent* WeaponSkeletalMeshComponent;                        // 0x0130 (size: 0x8)
    FName DirectionWeaponSocketName;                                                  // 0x0138 (size: 0x8)
    FRotator ExtraRotator;                                                            // 0x0140 (size: 0x18)
    TEnumAsByte<EBoneControlSpace> ControlSpace;                                      // 0x0158 (size: 0x1)
...
struct FAnimNode_TwoBoneIK_GSC : public FAnimNode_SkeletalControlBase
{
    FBoneReference IKBone;                                                            // 0x00C8 (size: 0x10)
    float StartStretchRatio;                                                          // 0x00D8 (size: 0x4)
    float MaxStretchScale;                                                            // 0x00DC (size: 0x4)
    class USkeletalMeshComponent* WeaponSkeletalMeshComponent;                        // 0x00E0 (size: 0x8)
    FName EffectorWeaponSocketName;                                                   // 0x00E8 (size: 0x8)
    FBoneReference JointBone;                                                         // 0x00F0 (size: 0x10)
    FVector JointBoneOffset;                                                          // 0x0100 (size: 0x18)
    FBoneReference WeaponBone;                                                        // 0x0118 (size: 0x10)
    FRotator ExtraRotator;                                                            // 0x0128 (size: 0x18)
    bool bUseSocketRotation;                                                          // 0x0140 (size: 0x1)
    FAxis TwistAxis;                                                                  // 0x0150 (size: 0x20)
    uint8 bAllowStretching;                                                           // 0x0170 (size: 0x1)
    uint8 bAllowTwist;                                                                // 0x0170 (size: 0x1)

}; // Size: 0x178

struct FAnimNode_TwoBoneShiftIK_GSC : public FAnimNode_SkeletalControlBase
{
    FBoneReference IKBone;                                                            // 0x00C8 (size: 0x10)
    float StartStretchRatio;                                                          // 0x00D8 (size: 0x4)
    float MaxStretchScale;                                                            // 0x00DC (size: 0x4)
    FVector EffectorOffset;                                                           // 0x00E0 (size: 0x18)
    FVector JointOffset;                                                              // 0x00F8 (size: 0x18)
    FAxis TwistAxis;                                                                  // 0x0118 (size: 0x20)
    uint8 bAllowStretching;                                                           // 0x0138 (size: 0x1)
    uint8 bAllowTwist;                                                                // 0x0138 (size: 0x1)

}; // Size: 0x140

struct FAnimNode_TwoBoneSimpleIK_GSC : public FAnimNode_SkeletalControlBase
{
    FBoneReference IKBone;                                                            // 0x00C8 (size: 0x10)
    float StartStretchRatio;                                                          // 0x00D8 (size: 0x4)
    float MaxStretchScale;                                                            // 0x00DC (size: 0x4)
    FBoneReference IKBoneTarget;                                                      // 0x00E0 (size: 0x10)
    FBoneReference JointBoneTarget;                                                   // 0x00F0 (size: 0x10)
    bool bSaveOriginalRotation;                                                       // 0x0100 (size: 0x1)
    FAxis TwistAxis;                                                                  // 0x0110 (size: 0x20)
    uint8 bAllowStretching;                                                           // 0x0130 (size: 0x1)
    uint8 bAllowTwist;                                                                // 0x0130 (size: 0x1)
