...
class AAIController : public AController
{
    ...
    bool bDebugDrawPrecalculatedNavigationPath;                                       // 0x036C (size: 0x1)
    ...
    class UPawnActionsComponent* ActionsComp;                                         // 0x0388 (size: 0x8)
...
{
    class UEnvQuery* QueryTemplate;                                                   // 0x0630 (size: 0x8)
    TArray<FEnvNamedValue> QueryParams;                                               // 0x0638 (size: 0x10)
    TArray<FAIDynamicParam> QueryConfig;                                              // 0x0648 (size: 0x10)
    float TimeLimitPerStep;                                                           // 0x0658 (size: 0x4)
    int32 StepToDebugDraw;                                                            // 0x065C (size: 0x4)
    EEnvQueryHightlightMode HighlightMode;                                            // 0x0660 (size: 0x1)
    uint8 bDrawLabels;                                                                // 0x0664 (size: 0x1)
    uint8 bDrawFailedItems;                                                           // 0x0664 (size: 0x1)
    uint8 bReRunQueryOnlyOnFinishedMove;                                              // 0x0664 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0664 (size: 0x1)
    uint8 bTickDuringGame;                                                            // 0x0664 (size: 0x1)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x0668 (size: 0x1)
    FNavAgentProperties NavAgentProperties;                                           // 0x0670 (size: 0x38)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x0318 (size: 0x18)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x0300 (size: 0x8)
...
{
    class UNavMovementComponent* MovementComp;                                        // 0x0120 (size: 0x8)
    class ANavigationData* MyNavData;                                                 // 0x0130 (size: 0x8)
