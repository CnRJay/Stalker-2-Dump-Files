...
{
    uint8 bAutoRegisterWithBudgetAllocator;                                           // 0x0FD8 (size: 0x1)
    uint8 bAutoCalculateSignificance;                                                 // 0x0FD8 (size: 0x1)
    uint8 bShouldUseActorRenderedFlag;                                                // 0x0FD8 (size: 0x1)
