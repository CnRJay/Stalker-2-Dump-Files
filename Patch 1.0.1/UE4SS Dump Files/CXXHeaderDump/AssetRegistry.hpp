...
class IAssetRegistry : public IInterface
{
    ...
    FAssetData K2_GetAssetByObjectPath(const FSoftObjectPath& ObjectPath, bool bIncludeOnlyOnDiskAssets);
    bool IsSearchAsync();
...
class UAssetRegistryHelpers : public UObject
{
    ...
    void SortAssetData(const TArray<FAssetData>& InAssetData, TArray<FAssetData>& OutAssetData);
    ...
    FString GetShortName(const FAssetData& InAssetData);
